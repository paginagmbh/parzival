...
<div id="introduction">
    <nav style="width:100%" class="nav"><span width="25%" class="nav" style="text-weight: bold">EINFÜHRUNG</span><span width="25%" class="nav">
          ...
          <router-link to="/V/115v/transcript">ZU DEN HANDSCHRIFTEN</router-link></span></nav>
    <div id="frontmatter">
    ...
    <div id="toc">
       ...
       <p class="tocentry"><a href="#_Toc389815995">&#xA0;&#xA0;&#xA0;&#xA0;1.5.2 V in der Fürstlich Fürstenbergischen Bibliothek in Donaueschingen</a></p>
       <p class="tocentry"><a href="#_Toc389815996">&#xA0;&#xA0;&#xA0;&#xA0;1.5.3 Aufbewahrung von V in der Badischen Landesbibliothek in Karlsruhe</a></p>
       ...
       <p class="tocentry"><a href="#_Toc389816006">&#xA0;&#xA0;&#xA0;&#xA0;2.3.1 Lamprecht von Brun als Besitzer von V'?</a></p>
       <p class="tocentry"><a href="#_Toc389816007">&#xA0;&#xA0;&#xA0;&#xA0;2.3.2 V' – Der Cod. Pal. germ. 317 der Heidelberger Palatina</a></p>
       <p class="tocentry"><a href="#_Toc389816008">&#xA0;&#xA0;&#xA0;&#xA0;2.3.3 Heutiger Standort von V': Die Biblioteca Casanatense in Rom</a></p>
       <p class="tocentry"><a href="#endOfText"></a></p>
       <hr/>
    </div>
    <div id="content">
       <!--<h1>Original und Kopie des ›Rappoltsteiner Parzifal‹ &#x2012; Handschriftliche Überlieferung und Textgenese im 14. Jahrhundert</h1>-->
       <p class="MsoNormal">Der ›Rappoltsteiner Parzifal‹ ist in zwei Handschriften überliefert: Karlsruhe, Badische
          Landesbibliothek,
                          <a href="https://digital.blb-karlsruhe.de/blbhs/Handschriften/content/titleinfo/101664">Donaueschingen 97</a> (im Folgenden
                          Hs. V), und Roma, Biblioteca Casanatense,
          <router-link to="/VV/001r/facsimile">Ms. 1409</router-link>
                          (im Folgenden Hs. V'). Die nach dem Entstehungsort benannte Textsammlung ›Rappoltsteiner
          Parzifal‹<a href="#_ftn1" id="_ftnref1" title="Rappoltsteiner Parzifal"><sup>[1]</sup></a> enthält in Hs. V Wolframs von Eschenbach ›Parzival‹<a href="#_ftn2" id="_ftnref2"><sup>[2]</sup>
                                     </a>sowie daran anschließend die ›Nuwer Parzifal‹ genannte Kompilation aus ›Conte du Graal‹
          (›Perceval‹)-Fortsetzungen<a href="#_ftn3" id="_ftnref3"><sup>[3]</sup></a>in deutscher Übertragung. Die Hs. V' hingegen überliefert den
                          ›Parzival‹ Wolframs nicht; der Codex setzt ein mit dem ›Nuwen Parzifal‹, dem zweiten
          Teil des ›Rappoltsteiner Parzifal‹.
                          Insbesondere der in Hs. V vorliegende Text wird in der Forschung in mehrfacher
          Hinsicht als »Glücksfall« beurteilt. Immer
                          wieder wird hingewiesen auf die ausführlichen Angaben zur Genese der Handschrift
          im Epilog des ›Rappoltsteiner Parzifal‹ sowie
                          auf die Tatsache, dass es sich bei Hs. V um eine Originalhandschrift handelt,
          also um jenes Exemplar, das der Auftraggeber in
                          Bestellung gegeben hat.<a id="_Ref348945462"></a><a href="#_ftn4" id="_ftnref4"><sup>[4]</sup></a></p>
       <p class="MsoNormal">Die ungewöhnliche
          Fülle an Informationen zur Entstehung des ›Rappoltsteiner Parzifal‹, die der Epilog
       ...
       <p class="MsoNormal">In den folgenden Ausführungen werden
          ...
          der Genese der Texte (Kap. 1.2), ihrer Verschriftlichung (Kap. 1.3 und 2.2) sowie
          bezüglich der
          Geschichte nach der Erstanfertigung (Kap. 1.4) und Besitzgeschichte (Kap. 1.5) der
          Handschriften.
       </p>
       <h3><a id="_Toc389815969"></a><a id="_Ref379010577"></a>1 Original: Handschrift V –
       ...
       <p class="MsoNormal">Als schlüssiges Indiz dafür, dass
          ...
          <router-link to="/V/300v/facsimile">300v</router-link>b, 5.
          Zeile von unten (NP 36200/36201; Sch. 839.39/40), weist darauf hin, dass
          zumindest Teile von V von einer Vorlage abgeschrieben wurden und es sich beim
       ...
       <h4>
                          <a id="_Toc389815970"></a>
                          <a id="_Ref379010634"></a>1.1 Beschreibung der Handschrift V
       </h4>
       <h5>
                          <a id="_Toc389815971"></a>
                          <a id="_Ref381880245"></a>
                          <a id="_Ref379125563"></a>1.1.1 Äußere Beschreibung
       </h5>
       ...
       <p class="MsoNormal">Ulrich von Rappoltstein   ·   Perg.,
          320 (von ursprünglich 322) Bll.   ·   38,5–39 x 27 cm   ·   Elsass (Straßburg
       ...
       <p class="MsoNormal">Blattzählung mit Tinte von alter Hand oben in der Blattmitte
          <router-link to="/V/001r/facsimile">1</router-link><i>–</i><router-link to="/V/072r/facsimile">72</router-link>
          (die Zahl 55 übersprungen), moderne Blattzählung mit Bleistift oben rechts
          (wird im Folgenden zitiert), beginnt ab Bl.
          <router-link to="/V/003r/facsimile">3</router-link>. 320
          von ursprünglich 322 Blättern mit einer Lücke von 2 Blättern nach Bl.
          <router-link to="/V/169v/facsimile">169</router-link>
          (heute reguläres Quinternio
          <router-link to="/V/162r/facsimile">162</router-link>–<router-link to="/V/171v/facsimile">171</router-link> mit
          Bindfäden zwischen <router-link to="/V/166v/facsimile">166</router-link> und
          <router-link to="/V/167r/facsimile">167</router-link>). Die Bll.
          <router-link to="/V/176r/facsimile">176</router-link> und
          <router-link to="/V/177r/facsimile">177</router-link> sind falsch eingebunden und gehören hinter Bl.
          <router-link to="/V/179v/facsimile">179</router-link>. Unterschiedlich dickes Pergament, ab Bl.
          <router-link to="/V/286r/facsimile">286</router-link>
          dickeres. Sehr dünne Stellen (nach Rasuren) mit Pergamentstreifen überklebt
          (z.B. Bl. <router-link to="/V/023r/facsimile">23r</router-link>).
       </p>
       <p class="MsoNormal"><b>Einband</b>: ### x ### großer Holzdeckel
          ...
          identisch). Einfache Streicheisenlinien. Mehrfach ausgebesserter, ### cm breiter
          Rücken (Überklebung und Unterlegung) mit ### Bünden. Im ### Feld
          Papierrückenschild von Johann Baptist Müller (1754–1814), Archivar und
          Bibliothekar in Donaueschingen (<i>Parzifal ::: | auf Pergament ::: 14.</i>)<i>.</i>
          Im ### Feld Signaturschild: ###. Zwei Schließen (Hinterdeckel-Vorderdeckel),
          die Schließenbleche mit Punzierung, die Lederriemen fehlen. <a href="https://digital.blb-karlsruhe.de/blbhs/content/pageview/495093">Vorderspiegel</a>:
          mindestens zwei aufeinander geklebte Lagen Pergament, davon einige Stücke (###
          x ###) abgelöst. Auf der obersten Lage Einträge des 14.–20. Jahrhunderts (siehe
          Kap. <a href="#_Toc389815990">1.4.1</a>, <a href="#_Toc389815994">1.5.1</a> und <a href="#_Toc389815996">1.5.3</a>).
          Auf zwei Stücken (### x ### und ### x ### cm)
          ...
          Spiegelblatt
          <router-link to="/V/320r/facsimile">320</router-link>/<a href="https://digital.blb-karlsruhe.de/blbhs/content/pageview/496505">Spiegelblatt
             recto</a> losgelöst, auf dem <a href="https://digital.blb-karlsruhe.de/blbhs/content/pageview/496506">Spiegelblatt
             verso</a> Reste einer Urkunde und eines Nekrologs (?) des 14. Jahrhunderts aufgeklebt,
       ...
       <p class="MsoNormal" style="text-indent:.1pt"><b>Buchblock</b>:
          38,5–39 x 27 cm. <b>Lagen</b>:<a href="#_ftn9" id="_ftnref9"><sup>[9]</sup></a> 2 V
          <router-link to="/V/020v/facsimile">20</router-link>
          + II
          <router-link to="/V/024v/facsimile">24</router-link>
          + 5 VI
          <router-link to="/V/084v/facsimile">84</router-link>
          + III
          <router-link to="/V/090v/facsimile">90</router-link>
          + I
          <router-link to="/V/092v/facsimile">92</router-link>
          + II
          <router-link to="/V/096v/facsimile">96</router-link>
          + VI
          <router-link to="/V/108v/facsimile">108</router-link>
          + (IV-1)
          <router-link to="/V/115v/facsimile">115</router-link>
          + (VI-2)
          <router-link to="/V/125v/facsimile">125</router-link><sup> </sup>+ (VI+I
          <router-link to="/V/133r/facsimile">133</router-link><sup>/</sup><router-link to="/V/134v/facsimile">134</router-link>)
          <router-link to="/V/139v/facsimile">139</router-link>
          + V
          <router-link to="/V/149v/facsimile">149</router-link>
          + VI
          <router-link to="/V/161v/facsimile">161</router-link>
          + V
          <router-link to="/V/171v/facsimile">171</router-link>
          + (V+I
          <router-link to="/V/176r/facsimile">176</router-link><sup>/</sup><router-link to="/V/177v/facsimile">177</router-link>)
          <router-link to="/V/183v/facsimile">183</router-link>
          + VI
          <router-link to="/V/195v/facsimile">195</router-link>
          + V
          <router-link to="/V/205v/facsimile">205</router-link>
          + III
          <router-link to="/V/211v/facsimile">211</router-link>
          + II
          <router-link to="/V/215v/facsimile">215</router-link>
          + V
          <router-link to="/V/225v/facsimile">225</router-link>
          + VI
          <router-link to="/V/237v/facsimile">237</router-link>
          + II
          <router-link to="/V/247v/facsimile">247</router-link>
          + I
          <router-link to="/V/249v/facsimile">249</router-link>
          + IV
          <router-link to="/V/257v/facsimile">257</router-link>
          + II
          <router-link to="/V/261v/facsimile">261</router-link>
          + (V+I
          <router-link to="/V/270r/facsimile">270</router-link><sup>/</sup><router-link to="/V/271v/facsimile">271</router-link>)<sup>273</sup>
          + 2 VI
          <router-link to="/V/297v/facsimile">297</router-link>
          + V
          <router-link to="/V/307v/facsimile">307</router-link>
          + VI
          <router-link to="/V/319v/facsimile">319</router-link>
          + I
          <router-link to="/V/320r/facsimile">320</router-link><sup>/</sup><a href="https://digital.blb-karlsruhe.de/blbhs/content/pageview/496505"><sup>Spiegelbl.</sup></a>
          (einige Reklamante noch erkennbar: Bll.
          <router-link to="/V/060v/facsimile">60v</router-link>,
          <router-link to="/V/072v/facsimile">72v</router-link>,
          <router-link to="/V/084v/facsimile">84v</router-link>,
          <router-link to="/V/090v/facsimile">90v</router-link>,
          <router-link to="/V/096v/facsimile">96v</router-link>,
          <router-link to="/V/108v/facsimile">108v</router-link>,
          <router-link to="/V/139v/facsimile">139v</router-link>,
          <router-link to="/V/149v/facsimile">149v</router-link>,
          <router-link to="/V/161v/facsimile">161v</router-link>,
          <router-link to="/V/273v/facsimile">273v</router-link>). <b>Schriftraum</b>:
          ### cm; zweispaltig, Verse abgesetzt, Versalien in eigener Spalte durch
          unterschiedlich ausgeprägte Tintenlinien begrenzt (33–33,5 x 17–19,5 cm) 33 x
          20 oder 19–19,5 x 22–23. Endpunkte (Einritzungen) für die Zeilen noch sichtbar,
          48–55 (meistens 49 oder 50) Zeilen pro Spalte. <b>Schrift</b>: Textura, fünf Hände
          (siehe <a href="#_Toc389815983">Kap. 1.3.1</a>).<a href="#_ftn10" id="_ftnref10"><sup>[10]</sup></a>
                          <b>Ausstattung</b>: 127 Überschriften
          in roter Tinte (im Folgenden mit &lt;…&gt; markiert), Namen rot gestrichelt. Teilweise
          sehr filigrane Fleuroné-Initialen von zwei unterschiedlichen Malerhänden (siehe
          <a href="#_Toc389815986">Kap. 1.3.2.1</a>), rote, blaue und teilweise grüne (Bl.
          <router-link to="/V/287v/facsimile">287v</router-link>b) Lombarden
          mit Verzierung (siehe <a href="#_Toc389815987">Kap. 1.3.2.2</a>), eine Vorgabe des Buchstabens ist z.B. auf
          Bl. <router-link to="/V/028r/facsimile">28r</router-link>a
          erkennbar. Ungerade Versanfänge rubriziert. <b>Korrekturen/Nachträge</b>:
          ...
          (z.B. Bll. <router-link to="/V/154r/facsimile">154r</router-link>a,
          <router-link to="/V/155r/facsimile">155r</router-link>b,
          <router-link to="/V/159v/facsimile">159v</router-link>b und
          <router-link to="/V/161v/facsimile">161v</router-link>a).
          Mit Tinte korrespondierende Zeichen, die darauf hinweisen, dass die Blätter
          <router-link to="/V/176r/facsimile">176</router-link> und
          <router-link to="/V/177r/facsimile">177</router-link>
          falsch eingebunden wurden: Bl.
          <router-link to="/V/175v/facsimile">175v</router-link>b unter
          der Spalte, und Bl.
          <router-link to="/V/178r/facsimile">178r</router-link>a, nach
          erster Zeile (x in Kreis); Bl.
          <router-link to="/V/176r/facsimile">176r</router-link>a, nach
          erster Zeile, und Bl.
          <router-link to="/V/179v/facsimile">179v</router-link>a,
          unterer Rand (Hantel/Brille), sowie Bl.
          <router-link to="/V/177v/facsimile">177v</router-link>b,
          ...
          <router-link to="/V/115r/facsimile">115r</router-link>b (<i>Lachmann
             S. 345.</i>). <b>Zustand</b>: Abgegriffen, fleckig, Einband abgenutzt, mit
          Löchern durch Wurmfraß.
       </p>
       <p class="MsoNormal"><b>Schreibsprache</b>:
          Niederalemannisch/elsässisch.<a href="#_ftn11" id="_ftnref11"><sup>[11]</sup></a></p>
       <h5><a id="_Toc389815972"></a><a id="_Ref381537839"></a>1.1.2 Inhalt</h5>
       <div class="contentbox-left"></div>
       ...
       <div class="contentbox-left"><router-link to="/V/001r/facsimile">1r</router-link>a–<router-link to="/V/115r/facsimile">115r</router-link>b</div>
       <div class="contentbox-right">[1.]<b>
             Wolfram von Eschenbach, ›Parzival‹ (Fassung *T), Buch I–XIV</b> (L. 1.1–733.30)
          <b>mit Prologus und Einschüben</b><a href="#_ftn12" id="_ftnref12"><sup>[12]</sup></a></div>
       <div style="clear:both"></div>
       <div class="contentbox-left"></div>
       ...
       <div class="contentbox-left">
          <router-link to="/V/001r/facsimile">1r</router-link>a–<router-link to="/V/017v/facsimile">17v</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/017v/facsimile">17v</router-link>b–<router-link to="/V/020r/facsimile">20r</router-link>b
       </div>
       ...
       <div class="contentbox-right metadata">Lit. zum
             Text: <span style="font-variant:small-caps">Heller</span> (1930), S. 112–118; <span style="font-variant:small-caps">Thompson</span> (1931), S. 13–17; <span style="font-variant:small-caps">Chen</span> (2015), S. 283–306.
       </div>
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/020r/facsimile">20r</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/020r/facsimile">20r</router-link>b–<router-link to="/V/029v/facsimile">29v</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/029v/facsimile">29v</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/029v/facsimile">29v</router-link>b–<router-link to="/V/037r/facsimile">37r</router-link>b
       </div>
       <div class="contentbox-right">[1.6]
            <b>Wolframs ›Parzival‹, Buch III–IV</b> (L. 175.5–223.30):<a href="#_ftn13" id="_ftnref13"><sup>[13]</sup></a>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/037r/facsimile">37r</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/037r/facsimile">37r</router-link>b–<router-link to="/V/051v/facsimile">51v</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/051v/facsimile">51v</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/051v/facsimile">51v</router-link>b–<router-link to="/V/115r/facsimile">115r</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
            <router-link to="/V/115r/facsimile">115r</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/115v/facsimile">115v</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left"></div>
       <div class="contentbox-right"><b>Freidank-Vers</b> (FR<a href="#_ftn14" id="_ftnref14"><sup>[14]</sup></a>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
           <router-link to="/V/115v/facsimile">115v</router-link>a–<router-link to="/V/115v/facsimile">115v</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/116r/facsimile">116r</router-link>a–<router-link to="/V/302r/facsimile">302r</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
           <router-link to="/V/116r/facsimile">116r</router-link>a–<router-link to="/V/120v/facsimile">120v</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
           <router-link to="/V/120v/facsimile">120v</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
            <router-link to="/V/120v/facsimile">120v</router-link>b–<router-link to="/V/150v/facsimile">150v</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
           <router-link to="/V/150v/facsimile">150v</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
           <router-link to="/V/150v/facsimile">150v</router-link>a–<router-link to="/V/154r/facsimile">154r</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
           <router-link to="/V/154r/facsimile">154r</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/154r/facsimile">154r</router-link>b–<router-link to="/V/165r/facsimile">165r</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
           <router-link to="/V/165r/facsimile">165r</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
           <router-link to="/V/179v/facsimile">179v</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
           <router-link to="/V/179v/facsimile">179v</router-link>b–<router-link to="/V/185v/facsimile">185v</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
            <router-link to="/V/185v/facsimile">185v</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/185v/facsimile">185v</router-link>a–<router-link to="/V/191v/facsimile">191v</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
            <router-link to="/V/191v/facsimile">191v</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/191v/facsimile">191v</router-link>a–<router-link to="/V/251v/facsimile">251v</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/251v/facsimile">251v</router-link>a–<router-link to="/V/263v/facsimile">263v</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/263v/facsimile">263v</router-link>b–<router-link to="/V/264r/facsimile">264r</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/264r/facsimile">264r</router-link>b–<router-link to="/V/302r/facsimile">302r</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
            <router-link to="/V/302r/facsimile">302r</router-link>a–<router-link to="/V/317v/facsimile">317v</router-link>a
       </div>
       ...
       <div class="contentbox-right">
            <router-link to="/V/302r/facsimile">302r</router-link>a–<router-link to="/V/307v/facsimile">307v</router-link>a [3.21.1]
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
            <router-link to="/V/307v/facsimile">307v</router-link>a–b [3.21.2] Einschub: ›Troisième
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/V/307v/facsimile">307v</router-link>b
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
            <router-link to="/V/307v/facsimile">307v</router-link>b–<router-link to="/V/308r/facsimile">308r</router-link>b [3.21.4]
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/V/308r/facsimile">308r</router-link>b–<router-link to="/V/308v/facsimile">v</router-link>a [3.21.5]
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/V/308v/facsimile">308v</router-link>a–<router-link to="/V/310r/facsimile">310r</router-link>b [3.21.6]
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/V/310r/facsimile">310r</router-link>b–<router-link to="/V/310v/facsimile">v</router-link>a [3.21.7]
          <b>Einschub: ›Troisième Continuation‹</b>, Ep. 29 und 30, dt. (Roach V, 42464–42468
          und 42469–42473) (L. <span class="versheader">784.<a id="784.28"></a>28<sup>1–10</sup></span>;
          Sch. LIII–LIV): <i>Kv́nig artus in groſze froͤude kam… – …Sv́ gelobetenz i(m)me alzehant</i></div>
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/V/310v/facsimile">310v</router-link>a–b [3.21.8]
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/V/310v/facsimile">310v</router-link>b [3.21.9]
          <b>Einschub</b> (L. 786.30<sup>1–2</sup>; Sch. LIV): <i>Kv́nig artus. vn(d) die
             tovelrunder alle / Mit in mit groſzeme ſchalle</i></div>
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/V/310v/facsimile">310v</router-link>b–<router-link to="/V/311r/facsimile">311r</router-link>a [3.21.10]
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
            <router-link to="/V/311v/facsimile">311v</router-link>b–<router-link to="/V/315r/facsimile">315r</router-link>b
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/V/315r/facsimile">315r</router-link>b
          [3.21.15] <b>Einschub</b> (L. 816.4<sup>1–4</sup>; Sch. LIV): <i>Oͮch liez man
             nv́t vnder wegen… – …Wart oͮch herlich genomen war</i></div>
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/V/315v/facsimile">315v</router-link>b–<router-link to="/V/316r/facsimile">316r</router-link>a
          [3.21.16] <b>Wolframs ›Parzival‹, Buch XVI</b> (L. 816.5–820.16): <i>Wie alle
             der templeiſen diet… – …Lot in got rehten ſin beiagen</i></div>
       <div style="clear:both"></div>
       <div class="contentbox-right">
            <router-link to="/V/316r/facsimile">316r</router-link><span lang="EN-US">a–b [3.21.17] <b>Einschub: ›Troisième
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/V/316r/facsimile">316r</router-link>b–<router-link to="/V/316v/facsimile">v</router-link>b [3.21.18]
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right"><a href="https://digital.blb-karlsruhe.de/blbhs/content/pageview/496472">316v</a>b [3.21.19]
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
            <router-link to="/V/316v/facsimile">316v</router-link>b–<router-link to="/V/317v/facsimile">317v</router-link>a [3.21.20]
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/317v/facsimile">317v</router-link>a–<router-link to="/V/320v/facsimile">320v</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/V/320v/facsimile">320v</router-link>a
       </div>
       ...
       <p class="MsoNormal metadata">Lit. zur Hs. (Auswahl): <span style="font-variant:small-caps">Uhland</span> (1840),
            ...
            auf der Internet-Plattform ‚<a
                href="http://www.manuscripta-mediaevalia.de/?xdbdtdn!%22obj%2031576740%22&amp;dmode=doc">Manuscripta Mediaevalia</a>’,
        ...
        <div class="motto verse">
            ...
            <p>(Die Minne sprach: »Ich gebiete dir, Ulrich, bei der
                Macht, die ich besitze – oder ich ziehe Dich in meinen Bann –: Lass dieses Buch
                machen, wir können nicht länger warten.«)</p>
            <p>(L. 827.30<sup>338–342</sup>; Sch. 853.16–20)</p>
       </div>
       <div style="clear:both"></div>
       <h4><a id="_Toc389815973"></a><a id="_Ref379010691"></a>1.2 Genese des Textes – Die Konzeption des <i>minnebuoch</i></h4>
       <p class="MsoNormal">Die Genese des Textes ›Nuwer Parzifal‹ sowie die Entstehungsgeschichte der gesamten (?) Hs. V werden im 558
          Verse umfassenden Epilog (L. 827.30<sup>1–558</sup>; Sch. 845.18–858.26) in
          Form eines »eigene[n], abgeschlossene[n] Stück[s] Kleinepik«<a href="#_ftn15" id="_ftnref15"><sup>[15]</sup></a>
          ...
          Personifikation <i>Minne</i> – nachdem die Personifikation <i>Milte</i><a href="#_ftn16" id="_ftnref16"><sup>[16]</sup></a>
          sie auf ihn aufmerksam gemacht hat – einen Ulrich von Rappoltstein zu ihrem
          besonderen Diener und beauftragt ihn, ein <i>minnebuoch </i>(vgl. L. 827.30<sup>184</sup>;
          ...
          handelt. Der in der Tradition der Minne- und Ehrenreden verfasste Epilog<a href="#_ftn17" id="_ftnref17"><sup>[17]</sup></a>
          ...
          Epilog lässt sich inhaltlich wie folgt gliedern:<a href="#_ftn18" id="_ftnref18"> <sup>[18]</sup></a></p>
       <p class="metadata">Überschrift mit Zuweisungen</p>
       <ul class="metadata">
          <li>des Epilogs an Philipp Colin (L. 827.30 <sup>1-0</sup>; Sch. 845.14–17),</li>
          <li>der Verfasserschaft von Wolframs von Eschenbach ›Parzival‹ (L. 827.30 <sup>1–24</sup>; Sch. 845.18–846.16),</li>
          <li>der Verfasserschaft des ›Rappoltsteiner Parzifal‹ an Philipp Colin (L. 827.30 <sup>25–31</sup>; Sch. 846.17–23).</li>
       </ul>
       ...
       <p class="metadata">Schilderung
             ...
             den Geschichten der Tafelrunder (L. 827.30<sup>80–116</sup>; Sch. 847.32–848.22).
       </p>
       ...
       <p class="metadata" style="margin-left:35.45pt">Hinweis, dass der Brief an die Herzenswand geschrieben und
             ...
             Name genannt werden wird (L. 827.30<sup>151–167</sup>; Sch. 849.11–27).
       </p>
       <p class="metadata" style="margin-left:35.45pt">Einleitung des
             Minnebriefs der <i>Minne</i> an Ulrich (L. 827.30<sup>168–192</sup>; Sch. 849.28–850.6).
       </p>
       <p class="metadata" style="margin-left:35.45pt">Minnebrief der <i>Minne</i>
             an das Herz Ulrichs (L. 827.30<sup>192–246</sup>; Sch. 850.6–851.14).
       </p>
       <p class="metadata" style="margin-left:35.45pt;text-indent: -35.45pt">Das Dichter-Ich leitet zur Reaktion von
             Ulrichs Herz (in Form allegorischer Dialoge) über (L. 827.30<sup>247–255</sup>; Sch. 851.15–23).
       </p>
       <p class="metadata" style="margin-left:35.45pt">Der Mund Ulrichs wendet
             sich an das Herz und die Sinne (L. 827.30<sup>255–266</sup>; Sch. 851.23–34).
       </p>
       <p class="metadata" style="margin-left:35.45pt">Das Herz Ulrichs spricht
             zur <i>Minne</i> (L. 827.30<sup>267–270</sup>; Sch. 851.35–38).
       </p>
       <p class="metadata" style="margin-left:35.45pt;">Die <i>Minne</i> spricht
             zum Herzen Ulrichs (L. 827.30<sup>271–328</sup>; Sch. 851.39–853,5).
       </p>
       <p class="metadata">Überleitung (L. 827.30<sup>329–335</sup>; Sch. 853.6–12).</p>
       <p class="metadata" style="margin-left:35.45pt">Gespräch
             zwischen <i>Minne</i> und <i>Milte</i> (L. 827.30<sup>336–351</sup>; Sch. 853.13–29).
       </p>
       <p class="metadata">Schilderung der Entstehung und des Zweckes des Buches (L. 827.30<sup>352–523</sup>; Sch. 853.30–857.17).</p>
       <p class="metadata">Anempfehlung Philipp Colins an Gott (L. 827.30<sup>524–539</sup>; Sch. 857.18–858.7).</p>
       <p class="metadata"><i>milte</i>-Appell des Dichters an das edle Herz (Ulrichs) (L. 827.30<sup>540–558</sup>; Sch. 858.8–26).</p>
       <p class="MsoNormal">Der Auftraggeber Ulrich von
          Rappoltstein, dessen Wappenschild von der personifizierten <i>Milte</i>
          ausführlich beschrieben wird,<a href="#_ftn19" id="_ftnref19"><sup>[19]</sup></a> ist im Epilog »zu einem
          würdigen Nachfahren des sagenhaften König Artus« stilisiert.<a href="#_ftn20" id="_ftnref20"><sup>[20]</sup></a>
          ...
          Tafelrunde schreiben ließ und in dem er gerne las.<a href="#_ftn21" id="_ftnref21"><sup>[21]</sup></a>
          Ulrich wird dabei nicht nur als Artus’ Erbe und Blutsverwandter dargestellt,<a href="#_ftn22" id="_ftnref22"><sup>[22]</sup></a>
          sondern auch als »vorbildliche[r] Minner[]«.<a href="#_ftn23" id="_ftnref23"><sup>[23]</sup></a></p>
       ...
       <h5>
                          <a id="_Toc389815974"></a>
                          <a id="_Ref381896899"></a>
                          <a id="_Ref381540316"></a>
                          <a id="_Ref381538261"></a>
                          <a id="_Ref381537778"></a>
                          <a id="_Ref381537686"></a>
                          <a id="_Ref381367850"></a>1.2.1 Der Auftraggeber Ulrich von Rappoltstein
       </h5>
       <p class="MsoNormal">Laut Epilog wurde der
          ›Rappoltsteiner Parzifal‹ von einem an mehreren Stellen namentlich genannten
          Ulrich, Freiherr von Rappoltstein (Ribeaupierre),<a href="#_ftn24" id="_ftnref24"><sup>[24]</sup></a>
          ...
          (<i>der Stein</i>, Klein-Rappoltstein, Petit-Ribeaupierre).<a href="#_ftn25" id="_ftnref25"><sup>[25]</sup></a></p>
       <p class="MsoNormal">                Von den im
          ...
          Handschrift in Frage:<a href="#_ftn26" id="_ftnref26"><sup>[26]</sup></a></p>
       <p class="MsoNormal">1. Der erste ist der Edelmann <span style="letter-spacing:1.0pt">Ulrich,</span> unverheirateter Sohn des Ritters und
          ...
          in Bologna belegt<a href="#_ftn27" id="_ftnref27"><sup>[27]</sup></a> und noch 1335 als
          Domherr (Canonicus) in Straßburg tätig.<a href="#_ftn28" id="_ftnref28"><sup>[28]</sup></a></p>
       <p class="MsoNormal">2. Ein weiterer <span style="letter-spacing:1.0pt">Ulrich</span>, Sohn des Heinrich III., war 1313
          noch minderjährig und ist 1328 als Komptur der Dorlisheimer Johanniter bezeugt.<a href="#_ftn29" id="_ftnref29"><sup>[29]</sup></a></p>
       <p class="MsoNormal">3. Der Sohn Johanns, des Ritters
          ...
          Basel und Kircherr von Reichenweier (Riquewihr) war.<a href="#_ftn30" id="_ftnref30"><sup>[30]</sup></a>
          Wahrscheinlich als Domherr zurückgetreten, lebte er spätestens ab 1341 auf der
          der Burg Hoh(en)-Rappoltstein.<a href="#_ftn31" id="_ftnref31"><sup>[31]</sup></a> Im Jahr 1353 (Eingang
          ...
          <a href="#_Toc389815988">1.3.2.3</a>) begraben.<a href="#_ftn32" id="_ftnref32"><sup>[32]</sup></a></p>
       <p class="MsoNormal">Bislang konnte nicht eindeutig
          ...
          des Johann (3.).<a href="#_ftn33" id="_ftnref33"><sup>[33]</sup></a> Diese beiden wurden
          ...
          haben.<a href="#_ftn34" id="_ftnref34"><sup>[34]</sup></a></p>
       <h6>
                          <a id="_Toc389815975"></a>
                          <a id="_Ref381368028"></a>1.2.1.1 Abfassungszeit
       </h6>
       <p class="MsoNormal">Als Jahr der Vollendung des ›Rappoltsteiner
          ...
          Bl.
          <router-link to="/V/115r/facsimile">115r</router-link>b–
          <router-link to="/V/115v/facsimile">v</router-link>a von
          Hs. V das Jahr 1336 angegeben:<a href="#_ftn35" id="_ftnref35"><sup>[35]</sup></a></p>
       ...
       <p class="MsoNormal">Zu recht hat <span style="font-variant:small-caps">Manfred Günter Scholz</span> darauf
          ...
          vielleicht der Vollendung der gesamten Hs. V handelt.<a href="#_ftn36" id="_ftnref36"><sup>[36]</sup></a>
          Jedenfalls erstreckte sich die Gesamtherstellung der Handschrift gemäß Angaben
          im Epilog und im Kolophon auf fünf Jahre.<a href="#_ftn37" id="_ftnref37"><sup>[37]</sup></a></p>
       <h6>
                          <a id="_Toc389815976"></a>1.2.1.2 Abfassungsort
       </h6>
       <p class="MsoNormal"><span style="font-variant:small-caps">Schorbach</span>
          ...
          entstanden ist.<a href="#_ftn38" id="_ftnref38"><sup>[38]</sup></a> Während der
          ...
          Groß-Rappoltstein und Herr in der Rappoltsweiler Neustadt und Oberstadt.<a href="#_ftn39" id="_ftnref39"><sup>[39]</sup></a>
          Er war der Ehemann der Elisabeth von Geroldseck,<a href="#_ftn40" id="_ftnref40"><sup>[40]</sup></a>
          der Bruder der Sophia, Äbtissin von Andlau,<a href="#_ftn41" id="_ftnref41"><sup>[41]</sup></a> und der Vater Johanns
       ...
       <h5>
                          <a id="_Toc389815977"></a>1.2.2 Konzepteure, Kompilatoren, Dichter und Übersetzer
       </h5>
       ...
       <h6>
                          <a id="_Toc389815978"></a>1.2.2.1 Philipp Colin
       </h6>
       <p class="MsoNormal">Bereits in einer vorangehenden Rubrik
          wird Philipp Colin (<span class="titel1"><i>pfilippes kolin</i></span>) als
          Verfasser des Epilogs genannt.<a href="#_ftn42" id="_ftnref42"><sup>[42]</sup></a> Der Epilog seinerseits
          enthält eine Darstellung der Genese des Textes, in der Colin als kluger
          (kundiger?) Goldschmied<a href="#_ftn43" id="_ftnref43"><sup>[43]</sup></a> aus oder wohnhaft in
          Straßburg vorgestellt wird, der als Konzepteur und Dichter das vorliegende Buch
          für seinen Herrn aus französischen in deutsche Reime gebracht habe.<a href="#_ftn44" id="_ftnref44"><sup>[44]</sup></a>
          In Vers L. 827.30<sup>163</sup> (Sch. 849.23) tritt der Erzähler Philipp Colin erstmals
          in der ersten Person auf.<a href="#_ftn45" id="_ftnref45"><sup>[45]</sup></a> Colin berechnet für die
          ...
          bereits geleistetes Entgelt in Naturalien mitgezählt wurde.<a href="#_ftn46" id="_ftnref46"><sup>[46]</sup></a></p>
       <p class="MsoNormal">Bei dem erwähnten
          Philipp Colin handelt sich möglicherweise um den urkundlich 1307 und 1309
          bezeugten<a href="#_ftn47" id="_ftnref47"><sup>[47]</sup></a> Sohn des in Straßburg
          wohnhaften Burkhard Kolin und Bruder des Klaus Kolin<a href="#_ftn48" id="_ftnref48"><sup>[48]</sup></a>
          sowie der Begine Anna. Dieser Philipp Colin hat zusammen mit seiner Gattin
          Katherine<a href="#_ftn49" id="_ftnref49"><sup>[49]</sup></a> am 5.9.1309 für 21 Mark
          Straßburger Silber seinen Anteil an der <span lang="DE-CH">Rheinsfahre
             ...
             Hundsfeld (Gemarkung Eckartsweier bei Kehl)</span> <span lang="DE-CH">an den Straßburger Bürger Diether Kölbelin</span><a href="#_ftn50" id="_ftnref50"><sup>[50]</sup></a>
          veräußert, dem Philippes Schwester, die Begine Anna, bereits am 29.4.1309 ihren
          Anteil für 20 Mark Silber verkauft hatte.<a href="#_ftn51" id="_ftnref51"><sup>[51]</sup></a></p>
       <h6><a id="_Toc389815979"></a><a id="_Ref381896925"></a><a id="_Ref381536118"></a><a id="_Ref379125397"></a>1.2.2.2 Klaus Wisse</h6>
       <p class="MsoNormal">Mitten im Epilog, im Anschluss an
          die erwähnte Bannandrohung an Ulrich von Rappoltstein durch die Minne (L.
       ...
       <p class="verse">(L. 827.30<sup>365–380</sup>; Sch. 853.43–854.11)
       </p>
       <p class="MsoNormal">Scheinbar hat ein Jahr vor Colin
          ...
          erstellt. Ob sein Beitrag lediglich den Prologus, also die Übertragung der afr.
          ›Élucidation‹ umfasst hat, wie dies <span style="font-variant:small-caps">Schorbach</span>
          vermutet, lässt sich nicht mehr entscheiden.<a href="#_ftn52" id="_ftnref52"><sup>[52]</sup></a> Eine Vermutung bleibt
          ...
          worden« sei.<a href="#_ftn53" id="_ftnref53"><sup>[53]</sup></a></p>
       <h6>
                          <a id="_Toc389815980"></a>
                          <a id="_Ref381896941"></a>
                          <a id="_Ref381536191"></a>
                          <a id="_Ref379125415"></a>1.2.2.3 Samson Pine
       </h6>
       <p class="MsoNormal"><a id="_Ref381536149"></a>Neben
          Philipp Colin und Klaus Wisse wird der Jude Samson Pine namentlich genannt, der
          laut dem Epilog bei der Arbeit am ›Rappoltsteiner Parzifal‹ behilflich war.<a href="#_ftn54" id="_ftnref54"><sup>[54]</sup></a>
       ...
       <p class="verse">(L. 827.30<sup>395–404</sup>; Sch. 854.27–36)
       </p>
       <p class="MsoNormal">Als Angehöriger des jüdischen
          ...
          Oberstadt, Johannes von Rappoltstein, Vater Ulrichs IV.<a href="#_ftn55" id="_ftnref55"><sup>[55]</sup></a>
          Falls auch Samson Pine der seit Beginn des 14. Jahrhunderts nachweisbaren Judengemeinde
          in Rappoltsweiler<a href="#_ftn56" id="_ftnref56"><sup>[56]</sup></a> angehört hat, wäre er als
          Leibeigener Johannes’ von Rappoltstein zur Mitarbeit am ›Rappoltsteiner
          Parzifal‹ verpflichtet gewesen.
       </p>
       <h5>
                          <a id="_Toc389815981"></a>1.2.3 Benutzte Vorlagen
       </h5>
       ...
       <p class="MsoNormal">                Der Prologus
          (1.2) folgt einer Fassung der afr. ›Élucidation‹, die der einzig bekannten
          ...
          afr. Prosafassung im Pariser Druck von 1530 gegen ihn verhält.<a href="#_ftn57" id="_ftnref57"><sup>[57]</sup></a>
          ...
          in seiner Ausgabe<a href="#_ftn58" id="_ftnref58"><sup>[58]</sup></a> berücksichtigten
          Handschriften in eine direkte Verbindung zum ›Rappoltsteiner Parzifal‹ gebracht
          werden.<a href="#_ftn59" id="_ftnref59"><sup>[59]</sup></a> Dasselbe gilt auch für
       ...
       <p class="MsoNormal">                Wolframs von
          ...
          unterschiedliche Stufen der Be- und Überarbeitung beobachtet werden können.<a href="#_ftn60" id="_ftnref60"><sup>[60]</sup></a> <span style="font-variant:small-caps">Robert Schöller</span> fasst die komplizierte
       ...
       <blockquote class="Blockquote">»Der Text von ›Parzival‹ V wurde zunächst nach einer
             ...
             vorhanden waren.« <a href="#_ftn61" id="_ftnref61"><sup>[61]</sup></a>
       </blockquote>
       <p class="MsoNormal">Die direkten Vorlagen von Hs. V
          ...
          entstanden.<a href="#_ftn62" id="_ftnref62"><sup>[62]</sup></a> Die erhaltenen *m-Textzeugen
          ...
          Johannes Mentelin 1477 erstellte Ausgabe.<a href="#_ftn63" id="_ftnref63"><sup>[63]</sup></a> Die letzte Handschrift,
       ...
       <p class="MsoNormal">                Isolierte
          ...
          <router-link to="/V/115v/facsimile">115v</router-link>a von
          ...
          gemeinsam mit den Versen FR 62,12f. wiedergibt.<a href="#_ftn65" id="_ftnref65"><sup>[65]</sup></a></p>
       <p class="MsoNormal">                Die sieben bekannten
          Minneliedstrophen im sogenannten ›Rappoltsteiner Florilegium‹ auf demselben
          <router-link to="/V/115v/facsimile">115v</router-link> sind
          einzeln weit verbreitet, finden sich in dieser Zusammenstellung jedoch lediglich
          in Hs. V und Hs. V',<a href="#_ftn66" id="_ftnref66"><sup>[66]</sup></a> die auf Bl.
          <router-link to="/V/320v/facsimile">320v</router-link>a
          nachgetragene Zusatzstrophe wiederum überliefert nur Hs. V.
       </p>
       <h4><a id="_Toc389815982"></a><a id="_Ref379010745"></a>1.3 Genese der Handschrift V
       </h4>
       ...
       <h5><a id="_Toc389815983"></a><a id="_Ref379014675"></a>1.3.1 Die Schreiber</h5>
       <p class="MsoNormal"><a id="_Ref381536263"></a>Auf Bl.
          <router-link to="/V/320v/facsimile">320v</router-link>a von
          ...
          Pfandbesitz,<a href="#_ftn67" id="_ftnref67"><sup>[67]</sup></a> heute: Département
       ...
       <p class="verse">(L. 827.30<sup>562–571</sup>; Sch. XVI)</p>
       <p class="MsoNormal">Nicht eindeutig bestimmen lässt sich in diesem Eintrag, ob es sich beim Namen <i>Henselin</i> um eine Kurzform
           ...
           Nachname gemeint ist.<a href="#_ftn68" id="_ftnref68"><sup>[68]</sup></a> Infrage kommen somit
           Vertreter folgender Namenskombinationen: <i>Henselin</i> (Johannes) <i>Schriber</i>
           (Nachname), ein Schreiber mit Vorname <i>Henselin</i> (Johannes)<a href="#_ftn69" id="_ftnref69"><sup>[69]</sup></a>
           sowie ein Schreiber mit Nachname <i>Henslin</i><a href="#_ftn70" id="_ftnref70"><sup>[70]</sup></a>.
       ...
       <p class="MsoNormal">Da die Aussage
          ...
          eindeutiges <i>per me</i> fehlt,<a href="#_ftn71" id="_ftnref71"><sup>[71]</sup></a> muss es sich beim
          Eintrag auch nicht unbedingt um das Kolophon des genannten, laut der Forschung
          ersten von zwei Schreibern handeln.<a href="#_ftn72" id="_ftnref72"><sup>[72]</sup></a> Wahrscheinlicher ist,
          ...
          genannten Mann <i>von Onhein</i> um einen zweiten Schreiber der Hs. V handelt.<a href="#_ftn73" id="_ftnref73"><sup>[73]</sup></a>
       ...
       <p class="MsoNormal">Tatsächlich
          ...
          haben.<a href="#_ftn74" id="_ftnref74"><sup>[74]</sup></a> Von der Schreiberhand I stammt
          das erste Doppelblatt (Bl.
          <router-link to="/V/001r/facsimile">1</router-link>/<router-link to="/V/010v/facsimile">10</router-link>) der
          Handschrift. Dieses umfasst die von Hand II beschriebenen Blätter
          <router-link to="/V/002r/facsimile">2</router-link>–<router-link to="/V/009v/facsimile">9</router-link> der
          ersten Lage und scheint das ursprüngliche Blatt dieser Lage ersetzt zu haben. Hand
          II schrieb zudem die zweite Lage (Bl.
          <router-link to="/V/011r/facsimile">11</router-link>–<router-link to="/V/020v/facsimile">20</router-link>), die
          ...
          <router-link to="/V/021r/facsimile">21</router-link>–<router-link to="/V/274v/facsimile">274</router-link>)
          ...
          <router-link to="/V/312v/facsimile">312v</router-link>b–<router-link to="/V/320v/facsimile">320v</router-link>a). Von
          ...
          <router-link to="/V/115v/facsimile">115v</router-link>a/b
          sowie eine Blattberechnung am Schluss von Hs. V (Bl.
          <router-link to="/V/320v/facsimile">320v</router-link>a).<a href="#_ftn75" id="_ftnref75"><sup>[75]</sup></a>
          ...
          das gesamte Bl.
          <router-link to="/V/069r/facsimile">69</router-link>.<a id="_Ref355268284"></a><a href="#_ftn76" id="_ftnref76"><sup>[76]</sup></a></p>
       ...
       <table style="border:0">
          ...
          <tbody>
             <tr>
                <td>Hand I</td>
                <td>Bl.
                   <router-link to="/V/001r/facsimile">1</router-link>
                </td>
                <td>L. 1.01–7.20</td>
             </tr>
             <tr>
                <td>Hand II</td>
                <td>Bl.
                   <router-link to="/V/002r/facsimile">2</router-link>–<router-link to="/V/009v/facsimile">9</router-link>
                </td>
                <td>L. 7.21–60.24</td>
             </tr>
             <tr>
                <td>Hand I</td>
                <td>Bl.
                   <router-link to="/V/010r/facsimile">10</router-link>
                </td>
                <td>L. 60.25–67.14</td>
             </tr>
          </tbody>
       ...
       <table style="border:0">
          ...
          <tbody>
             <tr>
                <td>Hand II</td>
                <td>Bl.
                   <router-link to="/V/011r/facsimile">11</router-link>–<router-link to="/V/020v/facsimile">20</router-link>
                </td>
       ...
       <table style="border:0">
          ...
          <tbody>
             <tr>
                <td>Hand III</td>
                <td>Bl.
                    <router-link to="/V/021r/facsimile">21</router-link>–<router-link to="/V/108v/facsimile">108</router-link>
                </td>
             ...
             <tr>
                <td colspan="3"><i>(in diesem Bereich wurden auf mehreren der herausgeschnittenen und wieder eingeklebten
                    Blättern </i><router-link to="/V/050r/facsimile">50</router-link><i>, </i><router-link to="/V/051r/facsimile">51</router-link><i>,
                    </i><router-link to="/V/055r/facsimile">55</router-link><i>,</i>
                    <router-link to="/V/056r/facsimile">56</router-link><i>,</i>
                    <router-link to="/V/057r/facsimile">57</router-link><i>,</i>
                    <router-link to="/V/059r/facsimile">59</router-link><i>,</i>
                    <router-link to="/V/063r/facsimile">63</router-link><i>,</i>
                    <router-link to="/V/064r/facsimile">64</router-link><i>,</i>
                    <router-link to="/V/065r/facsimile">65</router-link><i>,</i>
                    <router-link to="/V/066r/facsimile">66</router-link><i>,</i>
                    <router-link to="/V/069r/facsimile">69</router-link><i> und</i>
                    <router-link to="/V/087r/facsimile">87</router-link><i> Korrekturen von Hand V vorgenommen; Bl.</i>
                    <router-link to="/V/069r/facsimile">69</router-link> <i>stammt gänzlich von ihr)</i>
                </td>
             </tr>
          </tbody>
       </table>
       <table style="border:0">
          ...
          <tbody>
             <tr>
                <td>Hand I</td>
                <td>Bl.
                   <router-link to="/V/109r/facsimile">109</router-link>–<router-link to="/V/115v/facsimile">115v</router-link>a
                </td>
       ...
       <table style="border:0">
          ...
          <tbody>
             <tr>
                <td>Hand III</td>
                <td>Bl.
                   <router-link to="/V/116r/facsimile">116</router-link>–<router-link to="/V/124v/facsimile">124</router-link>
                </td>
             ...
             <tr>
                <td>Hand I</td>
                <td>Bl.
                   <router-link to="/V/125r/facsimile">125</router-link>
                </td>
                <td>NP 1762–1955 (Sch. 41.3–45.20)</td>
             </tr>
             <tr>
                <td>Hand III</td>
                <td>Bl.
                   <router-link to="/V/126r/facsimile">126</router-link>
                </td>
                <td>NP 1956–31113 (Sch. 45.21–716.45)</td>
             </tr>
             <tr>
                <td>Hand I</td>
                <td>Bl.
                   <router-link to="/V/274v/facsimile">274v</router-link>b–<router-link to="/V/312v/facsimile">312v</router-link>b
                </td>
             ...
             <tr>
                <td>Hand IV</td>
                <td>Bl.
                   <router-link to="/V/312v/facsimile">312v</router-link>b–<router-link to="/V/320v/facsimile">320v</router-link>a
                </td>
       ...
       <h6><a id="_Toc389815984"></a><a id="_Ref379014834"></a>1.3.1.1 Korrekturvorgänge</h6>
       ...
       <p class="MsoNormal">1. Der Schreiber III kopiert auf Bl.
          <router-link to="/V/040v/facsimile">40v</router-link>b
       ...
       <h5><a id="_Toc389815985"></a><a id="_Ref379125439"></a><span style="font-variant:small-caps">1.3.2 </span>Buchschmuck</h5>
       <p class="MsoNormal"><span style="font-variant:small-caps">Ute Obhof</span> kam 2009 zum Schluss, dass der Buchschmuck der Hs. V von
           zwei unterschiedlichen Malerhänden (im Folgenden als Malerhände I und II bezeichnet) stammt.<a href="#_ftn77" id="_ftnref77"><sup>[77]</sup></a>
          Tatsächlich lassen sich sowohl bei der Ausstattung der siebzehn mehrfarbigen,
          zwei- bis fünfzeiligen <span style="letter-spacing:1.0pt">Fleuronné-Initialen</span>
          sowie bei den zweizeiligen, roten und blauen, mit Fleuronné in der Gegenfarbe
          verzierten <span style="letter-spacing:1.0pt">Lombarden</span> zwei unterschiedliche
          Ausführungen feststellen.<a href="#_ftn78" id="_ftnref78"><sup>[78]</sup></a> Ob diese Verzierungen
          allerdings von zwei Malern stammten oder ob ein einziger Maler in unterschiedlichem
          Duktus (zu unterschiedlichen Zeiten?) gearbeitet hat, lässt sich nicht
          bestimmen. Im Folgenden werden mit <span style="font-variant:small-caps">Obhof</span>
          zwei Malerhände unterschieden.
       </p>
       <h6><a id="_Toc389815986"></a><a id="_Ref379014741"></a>1.3.2.1 Initialen</h6>
       <p class="MsoNormal">Sieben drei- bis fünfzeiligen,
          ...
          von Eschenbach (Bl.
          <router-link to="/V/001r/facsimile">1r</router-link>–<router-link to="/V/115r/facsimile">115r</router-link>).
          Die ersten sechs dieser Initialen (Bll.
          <router-link to="/V/017v/facsimile">17v</router-link>b
          [vierzeilig],
          <router-link to="/V/020r/facsimile">20r</router-link>b
          [vierzeilig],
          <router-link to="/V/022v/facsimile">22v</router-link>a
          [vierzeilig],
          <router-link to="/V/025v/facsimile">25v</router-link>a
          [dreizeilig],
          <router-link to="/V/054v/facsimile">54v</router-link>a [fünfzeilig]
          und
          <router-link to="/V/080r/facsimile">80r</router-link>a
          ...
          <router-link to="/V/114v/facsimile">114v</router-link>b.<a href="#_ftn79" id="_ftnref79"><sup>[79]</sup></a>
       </p>
       <p class="MsoNormal">Von der <span style="letter-spacing:1.0pt">Malerhand II</span> hingegen stammen acht – im
          ...
          <router-link to="/V/115v/facsimile">115v</router-link>–<router-link to="/V/320v/facsimile">320v</router-link>) (Bll.
          <router-link to="/V/116r/facsimile">116r</router-link>a
          [vierzeilig],
          <router-link to="/V/126r/facsimile">126r</router-link>a
          [dreizeilig],
          <router-link to="/V/140v/facsimile">140v</router-link>a
          [dreizeilig],
          <router-link to="/V/141v/facsimile">141v</router-link>b
          [dreizeilig],
          <router-link to="/V/154r/facsimile">154r</router-link>b
          [vierzeilig],
          <router-link to="/V/159r/facsimile">159r</router-link>b [dreizeilig],
          <router-link to="/V/198v/facsimile">198v</router-link>b [dreizeilig]
          und
          <router-link to="/V/307v/facsimile">307v</router-link>a
          ...
          <router-link to="/V/001r/facsimile">1r</router-link>a: Unter
          Verwendung der Farben rot, blau und grün und analog zur Ausschmückung der
          Lombarde auf Bl.
          <router-link to="/V/287v/facsimile">287v</router-link>b
          (Vogel auch auf Bl.
          <router-link to="/V/160v/facsimile">160v</router-link>a)
          und analog zur Zierleiste mit Medaillon auf Bl.
          <router-link to="/V/288v/facsimile">288v</router-link>a hat
          die Malerhand II diese Lombarde auf Bl.
          <router-link to="/V/001r/facsimile">1r</router-link>a nachträglich
          zu einer Eingangsinitiale erweitert.<a href="#_ftn80" id="_ftnref80"><sup>[80]</sup></a></p>
       <h6><a id="_Toc389815987"></a><a id="_Ref379015022"></a>1.3.2.2 Lombarden</h6>
       <p class="MsoNormal">Bei den rot-blau und grün (Bl. <router-link to="/V/288v/facsimile">288v</router-link>a)
          alternierenden, außer bei den Majuskeln I und P jeweils zweizeiligen <span style="letter-spacing:1.0pt">Lombarden</span>
          mit vorgeschriebenen Buchstaben (gut sichtbar auf Bl.
          <router-link to="/V/030r/facsimile">30r</router-link>b) finden
          sich in beiden Teilen von beiden Malerhänden I und II Fleuroné-Ausschmücken in
          der Gegenfarbe und in grün (Bl.
          <router-link to="/V/287v/facsimile">287v</router-link>b).<a href="#_ftn81" id="_ftnref81"><sup>[81]</sup></a>
          Auch hier stammen die qualitativ anspruchsvolleren Verzierungen von der
          Malerhand I:<a id="_Ref355250946"></a><a href="#_ftn82" id="_ftnref82"><sup>[82]</sup></a>
       </p>
       <div>
          <figure style="max-width:24%"><img id="Bild1" src="img/image001.png" alt="Beschreibung: Bildschirmfoto 2017-11-06 um 09" />
             <figcaption>
                <router-link to="/V/024v/facsimile">24v</router-link>b
             </figcaption>
          </figure>
          <figure style="max-width:24%"><img src="img/image002.png" alt="Beschreibung: Bildschirmfoto 2017-11-06 um 10" />
             <figcaption>
                <router-link to="/V/030v/facsimile">30v</router-link>b
             </figcaption>
          </figure>
          <figure style="max-width:24%"><img id="Bild3" src="img/image003.png" alt="Beschreibung: Bildschirmfoto 2017-11-0 um 10" />
             <figcaption>
                <router-link to="/V/032r/facsimile">32r</router-link>b
             </figcaption>
          </figure>
          <figure style="max-width:24%"><img id="Bild4" src="img/image004.png" alt="Beschreibung: Bildschirmfoto 2017-11-06 um 10" />
             <figcaption>
                <router-link to="/V/032v/facsimile">32v</router-link>a
             </figcaption>
          </figure>
       </div>
       <div>
          <figure style="max-width:24%"><img id="Bild29" src="img/image005.png" alt="Beschreibung: Bildschirmfoto 2017-11-06 um 10" />
             <figcaption>
                <router-link to="/V/032v/facsimile">32v</router-link>b
             </figcaption>
          </figure>
          <figure style="max-width:24%"><img id="Bild30" src="img/image006.png" alt="Beschreibung: Bildschirmfoto 2017-11-06 um 10" />
             <figcaption>
                <router-link to="/V/042r/facsimile">42r</router-link>b
             </figcaption>
          </figure>
          <figure style="max-width:24%"><img id="Bild31" src="img/image007.png" alt="Beschreibung: Bildschirmfoto 2017-11-06 um 10" />
             <figcaption>
                <router-link to="/V/043r/facsimile">43r</router-link>a
             </figcaption>
          </figure>
          <figure style="max-width:24%"><img id="Bild32" src="img/image008.png" alt="Beschreibung: Bildschirmfoto 2017-11-06 um 10" />
             <figcaption>
                <router-link to="/V/043v/facsimile">43v</router-link>b
             </figcaption>
          </figure>
       </div>
       <p class="MsoNormal">Die Lombarden auf den neu eingeklebten Blättern der sechsten und siebten Lage des ersten Teils (Bll.
          <router-link to="/V/050r/facsimile">50</router-link>,
          <router-link to="/V/051r/facsimile">51</router-link>,
          <router-link to="/V/055r/facsimile">55</router-link>,
          <router-link to="/V/056r/facsimile">56</router-link>,
          <router-link to="/V/057r/facsimile">57</router-link>,
          <router-link to="/V/063r/facsimile">63</router-link>,
          <router-link to="/V/064r/facsimile">64</router-link>/<router-link to="/V/069r/facsimile">69</router-link>,
          <router-link to="/V/066r/facsimile">66</router-link> und
          <router-link to="/V/087r/facsimile">87</router-link>) hingegen
          wurden auschließlich von der Malerhand II verziert:<a id="_Ref354148322"></a></p>
       <div>
          <figure style="max-width:24%"><img id="Bild5" src="img/image009.png" alt="Beschreibung: V_50va" />
             <figcaption>
                <router-link to="/V/050v/facsimile">50v</router-link>a
             </figcaption>
          </figure>
          <figure style="max-width:24%"><img id="Bild6" src="img/image010.png" alt="Beschreibung: V_55ra" />
             <figcaption>
                <router-link to="/V/055r/facsimile">55r</router-link>a
             </figcaption>
          </figure>
          <figure style="max-width:24%"><img id="Bild7" src="img/image011.png" alt="Beschreibung: V_66ra" />
             <figcaption>
                <router-link to="/V/066r/facsimile">66r</router-link>a
             </figcaption>
          </figure>
          <figure style="max-width:24%"><img id="Bild8" src="img/image012.png" alt="Beschreibung: V_69ra" />
             <figcaption>
                <router-link to="/V/069r/facsimile">69r</router-link>a
             </figcaption>
          </figure>
       </div>
       <p class="MsoNormal">Wie Fadenausläufer auf den übriggebliebenen Fälzen der herausgeschnittenen Blätter
          <router-link to="/V/066r/facsimile">66</router-link>r und
          <router-link to="/V/069r/facsimile">69</router-link>r und
          <router-link to="/V/087r/facsimile">87</router-link>r
          zeigen, waren diese bereits verziert, als sie durch neue Blätter ersetzt wurden.
          Auf Bl.
          <router-link to="/V/066r/facsimile">66</router-link>r
          stammten die Verzierungen gemäß den noch erkennbaren Fadenausläfern auf dem
          Falz von der Malerhand I.<a href="#_ftn83" id="_ftnref83"><sup>[83]</sup></a> Die Lombarden von
          Malerhand II auf den neu beschriebenen Blättern wurden teilweise vor dem Beschneiden
          und Einkleben verziert (Bl.
          <router-link to="/V/087r/facsimile">87</router-link>r), teilweise
          erst nachdem das neue Blatt eingeklebt worden ist (Bl.
          <router-link to="/V/069r/facsimile">69</router-link>r).
       </p>
       ...
       <h6><a id="_Toc389815988"></a><a id="_Ref389752091"></a>1.3.2.3 Nachweis der Malerwerkstatt</h6>
       <p class="MsoNormal">Mittels Vergleichen konnte die im
          ...
          und Hymnar, die heute unter der Signatur <a href="https://digital.blb-karlsruhe.de/blbhs/content/titleinfo/1164333">Lichtenthal
             141</a> (= L) in der Badischen Landesbibliothek in Karlsruhe aufbewahrt wird,<a href="#_ftn84" id="_ftnref84"><sup>[84]</sup></a>
          sowie derjenige einer Sammelhandschrift mit der weit verbreiteten ›Historia Scholastica‹
          ...
          W) in der Aargauer Kantonsbibliothek in Aarau befindet.<a href="#_ftn85" id="_ftnref85"><sup>[85]</sup></a></p>
       <p class="MsoNormal">                Die
          ...
          im rot-blau gespaltenen Buchstabenkörper, durch kurz gewellte Fadenausläufer
       ...
       <div>
          ...
          <figure style="max-width:24%"><img id="Bild14" src="img/image020.png" alt="Beschreibung: Bildschirmfoto 2016-02-01 um 09" />
             <figcaption>V
                <router-link to="/V/054v/facsimile">54v</router-link>a
             </figcaption>
          </figure>
       ...
       <div>
          <figure style="max-width:24%"><img id="Bild15" src="img/image022.png" alt="Beschreibung: V_10vb" />V
             <router-link to="/V/010v/facsimile">10v</router-link>b
          </figure>
       ...
       <p class="MsoNormal">Der von demselben Maler bzw. aus
          ...
          Pergamenthandschrift des 15. Jahrhunderts.<a href="#_ftn86" id="_ftnref86"><sup>[86]</sup></a> Die liturgischen
          ...
          13. Jahrhundert Bücher für den Gottesdienst und das geistliche Leben schrieben.<a href="#_ftn87" id="_ftnref87"><sup>[87]</sup></a>
       ...
       <p class="MsoNormal">                Mit den Herren
          ...
          war.<a href="#_ftn88" id="_ftnref88"><sup>[88]</sup></a> Laut Nekrolog liegen in der
          ...
          Anniversarium eine Messe gehalten.<a href="#_ftn89" id="_ftnref89"><sup>[89]</sup></a></p>
       <p class="MsoNormal">                Im Kloster
          ...
          Kalligraphen bezeugt.<a href="#_ftn90" id="_ftnref90"><sup>[90]</sup></a> Einige der im 12. und
          13. Jahrhundert in dieser Schreibwerkstatt entstandenen Handschriften haben
          sich erhalten.<a href="#_ftn91" id="_ftnref91"><sup>[91]</sup></a> Möglicherweise im
          ...
          kann.<a href="#_ftn92" id="_ftnref92"><sup>[92]</sup></a> Die Initialornamentik der
       ...
       <h4><a id="_Ref389817114"></a><a id="_Toc389815989"></a>1.4 Zur Geschichte der Handschrift V nach der Erstanfertigung</h4>
       <h5><a id="_Toc389815990"></a><a id="_Ref379011674"></a>1.4.1 Neubindung</h5>
       <p class="MsoNormal">Mindestens einmal wurde die Hs. V
          ...
          <router-link to="/V/169v/facsimile">169v</router-link>) verloren
          gingen.<a href="#_ftn93" id="_ftnref93"><sup>[93]</sup></a> Im Vergleich zur
          Abschrift (Hs. V'), die an der entsprechenden Stelle (Bl.
          <router-link to="/VV/056r/facsimile">56r</router-link>b–
          <router-link to="/VV/058r/facsimile">58r</router-link>b)
          ...
          <router-link to="/V/176r/facsimile">176</router-link>
          und
          <router-link to="/V/177r/facsimile">177</router-link>
          falsch eingeheftet; sie gehören eigentlich hinter Bl.
          <router-link to="/V/179v/facsimile">179</router-link>, was
          die richtige Reihenfolge Bl.
          <router-link to="/V/175r/facsimile">175</router-link>, Bl.
          <router-link to="/V/178r/facsimile">178</router-link>, Bl.
          <router-link to="/V/179r/facsimile">179</router-link>, Bl.
          <router-link to="/V/176r/facsimile">176</router-link>, Bl.
          <router-link to="/V/177r/facsimile">177</router-link> und
          Bl.
          <router-link to="/V/180r/facsimile">180</router-link>
          ergibt. Darauf verweisen verschiedene mit Tinte gezeichnete korrespondierende
          Zeichen auf den genannten Blättern (siehe Kap.
          <a href="#_Toc389815971">1.1.1</a>).<a href="#_ftn94" id="_ftnref94"><sup>[94]</sup></a></p>
       <p class="MsoNormal">Als Einbandverstärkung dienten sowohl im Vorder- wie auch im Hinterspiegel
          beschriebene Pergamentblätter, von denen sich in den Innendeckeln des Einbandes
          schlecht lesbare Abklatsche erhalten haben. Im Vorderspiegel klebte das Blatt
          einer lateinischen theologischen Handschrift aus dem 13./14. Jahrhundert mit
          Texten über die Messe, über die Häretiker sowie über die Bestrafung. Auf den <a href="https://digital.blb-karlsruhe.de/blbhs/content/pageview/496511">Rückendeckel</a>
          innen, unter dem <a href="https://digital.blb-karlsruhe.de/blbhs/content/pageview/496505">Hinterspiegel</a>
          ...
          <i>alpurg</i><a href="#_ftn95" id="_ftnref95"><sup>[95]</sup></a> sowie <i>froneride</i>.
          ...
          Ehefrau Agnes) als Stifter auftritt.<a href="#_ftn96" id="_ftnref96"><sup>[96]</sup></a> Im zweiten Bruchstück,
          ...
          wurde.<a href="#_ftn97" id="_ftnref97"><sup>[97]</sup></a></p>
       ...
       <h5><a id="_Toc389815991"></a>1.4.2 Wappen</h5>
       <p class="MsoNormal">Auf dem <a href="https://digital.blb-karlsruhe.de/blbhs/content/pageview/496505">Hinterspiegel</a>
          ...
          Helm (Seitenansicht), Helmzier und Helmdecken zeigen, ausgeschlossen werden.<a href="#_ftn98" id="_ftnref98"><sup>[98]</sup></a>
          ...
          Rat und elsässischer Landvogt verstarb:<a href="#_ftn99" id="_ftnref99"><sup>[99]</sup></a>
       </p>
       <div>
          <figure style="max-width:24%;vertical-align: middle">
              ...
              <figcaption>Hs. V, <a href="https://digital.blb-karlsruhe.de/blbhs/content/pageview/496505">Hinterspiegel</a></figcaption>
          </figure>
          <figure style="max-width:24%;vertical-align: middle">
       ...
       <p class="MsoNormal">Die Federzeichnungen auf dem
          Hinterspiegel von Hs. V sind frühestens zu Beginn des 15. Jahrhunderts
          ...
          der beiden ersten Helme als Vorbilder dienten.<a href="#_ftn100" id="_ftnref100"><sup>[100]</sup></a></p>
       <h5><a id="_Toc389815992"></a><a id="_Ref379014918"></a><a id="_Ref379011612"></a>1.4.3 Nachträge</h5>
       <p class="MsoNormal">Neben eindeutig den
          ...
          Hs. V (Bl. <router-link to="/V/320v/facsimile">320v</router-link>)
          ...
          <router-link to="/V/320v/facsimile">320v</router-link>a mit
          brauner Tinte ein anonym überlieferter afr. Minnetext, in dem ein Dame
          angesprochen wird:<a href="#_ftn101" id="_ftnref101"><sup>[101]</sup></a></p>
       ...
       <p class="verse"><span lang="fro"><i>(estre)(?) bien que je nay de b(ien) f::: lay</i></span></p>
       <p class="verse"><span lang="fro"><i><s>ſo:::</s></i></span></p>
       <p class="verse"><span lang="fro"><i>ſouuenance gerant bien me fait(?) ly</i></span></p>
       <p class="verse"><span lang="fro"><i>ſovenir e(t) li doucey pleſance loin:</i></span></p>
       ...
       <p class="verse"><span lang="fro"><i>::: ſanblance lay :::ce</i></span></p>
       <p class="verse"><span lang="fro"><i>::: puiſance (?) q(ui) eſt e(n) ly</i></span></p>
       <p class="verse"><span lang="fro"><i>::: me rit de :::</i></span></p>
       <p class="verse"><span lang="fro"><i>::: li ſovenir rev::ir</i></span></p>
       <p class="MsoNormal">In der Mitte der Spalte von Bl.
          <router-link to="/V/320v/facsimile">320v</router-link>b
          steht mit schwarzer Tinte in großen (imitierten?) gotischen Minuskeln der
          Spruch <i>· ich · bin · gern · | lie·p·:· </i>(L. <span class="versheader">27.<a id="827.30"></a>30<sup>557-02</sup></span>). Am oberen Rand derselben Spalte
          finden sich auf zwei Zeilen verteilt heute unleserliche, identische (?)
          Federproben <i>ver::: d| ver:::nkude</i> (L. <span class="versheader">827.30<sup>557-01</sup>)</span>
          ...
          stammen auch Federproben auf dem <a href="https://digital.blb-karlsruhe.de/blbhs/content/pageview/495093">Vorderspiegel</a>:
       ...
       <h4><a id="_Toc389815993"></a><a id="_Ref379010798"></a><a id="_Ref379009959"></a><a id="_Ref379009896"></a><a id="_Ref379009886"></a><a id="_Ref379009882"></a><a id="_Ref379009869"></a><a id="_Ref379009807"></a><a id="_Ref379009784"></a><a id="_Ref379009753"></a><a id="_Ref379009752"></a>1.5 Besitzgeschichte der Handschrift V
       </h4>
       <h5><a id="_Toc389815994"></a><a id="_Ref379015302"></a><a id="_Ref379014940"></a><a id="_Ref379012129"></a><a id="_Ref379010940"></a>1.5.1 Die Grafen von Rappoltstein und von Helfenstein als Besitzer von V
       </h5>
       <p class="MsoNormal">Über einen Zeitraum von drei
          ...
          von Helfenstein überging.<a href="#_ftn102" id="_ftnref102"><sup>[102]</sup></a> Jedenfalls wurde der
          Codex gemäß Besitzeinträgen noch im 16. Jahrhundert von Mitgliedern der Familie
          gelesen. In der oberen Hälfte des <a href="https://digital.blb-karlsruhe.de/blbhs/content/pageview/495093">Vorderspiegels</a>
          finden sich von unterschiedlichen Händen drei Bücherzeichen mit Devisen,<a href="#_ftn103" id="_ftnref103"><sup>[103]</sup></a>
          die die Jahresangaben 1552 und 1553 aufweisen.<a href="#_ftn104" id="_ftnref104"><sup>[104]</sup></a></p>
       <p class="MsoNormal">                In einem
          Bücherzeichen mit der Devise <i>IVTG</i> (=<i>
                             </i>Ich vermisse Trennung
          gemach)<a href="#_ftn105" id="_ftnref105"><sup>[105]</sup></a> von 1552 werden mit den
          ...
          genannt.<a href="#_ftn106" id="_ftnref106"><sup>[106]</sup></a> Unterhalb dieses
          Bücherzeichens steht von anderer Hand ein weiteres, versehen mit der Jahreszahl
          1552 und der Devise <i>H.I.V.M.</i> (= Hoffe immer und [minne?]).<a href="#_ftn107" id="_ftnref107"><sup>[107]</sup></a>
          ...
          Schwester der beiden oben genannten.<a href="#_ftn108" id="_ftnref108"><sup>[108]</sup></a> Als drittes
          Bücherzeichen findet sich auf dem Vorderspiegel rechts des erstgenannten von
          einer weiteren Hand ein Eintrag aus dem Folgejahr 1553, in dem unterhalb der
          Devise <i>MHZG</i> (= Meine Hoffnung [Mein Hoffen] zu Gott)<a href="#_ftn109" id="_ftnref109"><sup>[109]</sup></a>
          ...
          dreiundzwanzigjährige <span style="letter-spacing:1.0pt">Margareta, Gräfin zu
             Helfenstein</span> (1530–1589).<a href="#_ftn110" id="_ftnref110"><sup>[110]</sup></a></p>
       <p class="MsoNormal">                Die beiden Schreiberhände
          ...
          <router-link to="/V/080v/facsimile">80v</router-link> mit den
          ...
          Frau Orgeluse trifft und ihr seine Ritterdienste anbietet (L. 508.15–509.9).<a href="#_ftn111" id="_ftnref111"><sup>[111]</sup></a>
       ...
       <p class="verse"><i>Got halcʒ jn <span class="titel1">ſ</span>einer húot</i><a href="#_ftn112" id="_ftnref112"><sup>[112]</sup></a></p>
       <p class="MsoNormal">(Hs. V, Bl.
          <router-link to="/V/080v/facsimile">80v</router-link>)
       </p>
       <p class="MsoNormal">Rechts von diesem Spruch, unterhalb der rechten Spalte von Bl.
          <router-link to="/V/080v/facsimile">80v</router-link> wird mit
          ...
          identifiziert.<a href="#_ftn113" id="_ftnref113"><sup>[113]</sup></a></p>
       <p class="MsoNormal">Eine weitere
          ...
          <router-link to="/V/153v/facsimile">153v</router-link> (NP 7328–7426;
          ...
          Graal‹ überliefert wird.<a href="#_ftn114" id="_ftnref114"><sup>[114]</sup></a> Unterhalb der ersten
          ...
          wird, nämlich mit <i>karadvß 2·1· </i>und<i> ſingenarin 21.</i><a href="#_ftn115" id="_ftnref115"><sup>[115]</sup></a>
          Unterhalb der zweiten Spalte hat vermutlich die erste Hand des Vorderspiegels
       ...
       <p class="verse">
            <i>vnd jn erle<span class="titel1">ſ</span>t | vom ʒerband</i><a href="#_ftn116" id="_ftnref116"><sup>[116]</sup></a>
       </p>
       <p class="MsoNormal">(Hs. V, Bl. <router-link to="/V/153v/facsimile">153v</router-link>)
       </p>
       <h5><a id="_Toc389815995"></a>1.5.2 V in der Fürstlich Fürstenbergischen Bibliothek in Donaueschingen</h5>
       <p class="MsoNormal">Über Elisabeth von
          Helfenstein-Wiesensteig (1527–84), seit 1543 Ehefrau Georgs, Freiherr zu
          ...
          <router-link to="/V/001r/facsimile">1r</router-link> und
          <router-link to="/V/320v/facsimile">320v</router-link>: <i>HOCHF
             · FÜRSTENB · BIBLIOTHEKE +</i>).<a href="#_ftn117" id="_ftnref117"><sup>[117]</sup></a></p>
       <p class="MsoNormal">                Erstmals ausdrücklich
          erwähnt wird die Aufbewahrung der Handschrift mit die Signatur <i>37.9.</i>
          (Einträge mit schwarzer Tinte auf dem <a href="https://digital.blb-karlsruhe.de/blbhs/content/pageview/495093">Vorderspiegel</a>)
          ...
          daraus veröffentlicht.<a href="#_ftn118" id="_ftnref118"><sup>[118]</sup></a> Bei der
          ...
          lediglich mit der Laufnummer IX. aufgeführt.<a href="#_ftn119" id="_ftnref119"><sup>[119]</sup></a> Bei der Neuordnung und
          ...
          Hs. V die Signatur »97«.<a href="#_ftn120" id="_ftnref120"><sup>[120]</sup></a></p>
       <h5>
                          <a id="_Toc389815996"></a>
                          <a id="_Ref379017708"></a>1.5.3 Aufbewahrung von V in der Badischen Landesbibliothek in Karlsruhe
       </h5>
       <p class="MsoNormal">Mit dem Verkauf der Sammlung der Fürstlich
          Fürstenbergischen Hofbibliothek an das Land Baden-Württemberg im Jahr 1993
          ...
          Karlsruhe, wo sie die Signatur <i>Donaueschingen 97</i> (Einträge auf dem <a href="https://digital.blb-karlsruhe.de/blbhs/content/pageview/495093">Vorderspiegel</a>
          mit Bleistift und Tinte: <i>Don 97</i>) erhielt,<a href="#_ftn121" id="_ftnref121"><sup>[121]</sup></a>
          unter der sie noch heute dort aufbewahrt wird.
       </p>
       <h3><a id="_Toc389815997"></a>2 Kopie: Handschrift V' – Roma, Biblioteca Casanatense, Ms. 1409
       </h3>
       <p class="MsoNormal">Mindestens einmal wurde Hs. V an
          ...
          einer Vers-für-Vers-Übertragung<a href="#_ftn122" id="_ftnref122"><sup>[122]</sup></a> erstellten Kopie Hs. V'
          handelt es sich mit hoher Wahrscheinlichkeit um eine direkte Abschrift von Hs. V
          ohne Zwischenstufen.<a href="#_ftn123" id="_ftnref123"><sup>[123]</sup></a> Die vielen, zum Teil
          sehr umfangreichen Kürzungen in Hs. V' (um die 5300 Minusverse gegenüber Hs. V)
          erfolgten nachweislich bei der Abschrift des Codex.<a href="#_ftn124" id="_ftnref124"><sup>[124]</sup></a>
          ...
          datierte Hs. V'<a href="#_ftn125" id="_ftnref125"><sup>[125]</sup></a> enthält lediglich den
          zweiten Teil (›Nuwer Parzifal‹) des ›Rappoltsteiner Parzifal‹.<a href="#_ftn126" id="_ftnref126"><sup>[126]</sup></a></p>
       <h4 style="margin-left:28.9pt;text-indent:-28.9pt">
                          <a id="_Toc389815998"></a>
                          <a id="_Ref379010666"></a>2.1 Beschreibung der Handschrift V'
       </h4>
       <h5><a id="_Toc389815999"></a>2.1.1 Äußere Beschreibung</h5>
       <p class="MsoNormal" style="text-indent:.1pt">
                          <b>›Rappoltsteiner
             Parzifal‹ (nur zweiter Teil): Minneliedstrophen; Klaus Wisse und Philipp Colin,
             ›Nuwer Parzifal‹ (stark gekürzt)</b>
       </p>
       <p class="MsoNormal">‘Epenwerkstatt’   ·   Perg., 3
          (Pap.) + 181 + 1 (Pap.) Bll.   ·   39 x 27,5  cm   ·   Raum Franken   ·   2. V.
          14. Jh.
       </p>
       <p class="MsoNormal">Blattzählung: III + 181 Bll. + I
          Bl. Moderne Paginierung (oben rechts) in Drucktypen
          <router-link to="/VV/001r/facsimile">1</router-link><i>–</i><router-link to="/VV/181r/facsimile">181</router-link>
          (wird im Folgenden zitiert). Alte Bleistiftzählung (oben rechts)
          <router-link to="/VV/001r/facsimile">1</router-link><i>–</i><router-link to="/VV/181r/facsimile">182</router-link>
          (springt von
          <router-link to="/VV/071r/facsimile">71</router-link>
          auf
          <router-link to="/VV/072r/facsimile">73</router-link>).
          Pergament unterschiedlicher Dicke mit Löchern (genäht). Vordere und hintere Vorsatzblätter
          aus Papier des 16. Jahrhunderts mit Wasserzeichen Kreis, von Stern überhöht |||
          60 mm, sehr ähnlich BR 488 (Ferrara 1583).
       </p>
       <p class="MsoNormal"><b>Einband</b>: Zwischen 1701 und
          1800 entstandener, 40,5 x 28 cm großer Einband (Kartondeckel mit Schweinsleder
          bezogen) (Vorderdeckel und Hinterdeckel identisch). 4 cm breiter Rücken mit
          sieben Bünden, im ersten Feld von oben Marke wie auf VSp., darunter mit
          schwarzer Tinte: <i>A:::</i>. Im zweiten Feld Rückenschild: <i>Parcefali Varior</i>[<i>um</i>]<i>
             | Rerum Natural</i>[<i>ium</i>]<i> | POEMA</i>. Im 4. Feld mit schwarzer Tinte
          die Ziffer <i>19</i>. Den Vorderspiegel bildet das auf den Deckel innen
          geklebte erste Blatt eines als Vorsatzblätter verwendeten Binio aus Papier. Auf
          dem Vorderspiegel eingetragen finden sich die alten Signaturen: <i>AR. I. 9.</i>
          (doppelt durchgestr.), <i>I A. I. 19.</i> (<i>I</i> = doppelt durchgestr.) und <i>Cod.
             1409</i>. Rechts neben diesen drei Signaturen eine Marke (3,5 x 3,5 cm) mit
          Aufschrift: <i>BIBLIOTECA</i> (horizontal oben); <i>ROMA</i> (horizontal unten);
          <i>REGIA</i> (vertikal links); <i>CASANATENSE</i> (vertikal rechts). Im Kreis: <i>Mss.</i>,
          darunter Stempel: <i>1409</i>. Auf dem letzten, dritten Blatt des Binio auf der
          Rectoseite mit Tinte <i>Paracefali</i> | <i>Poema lingua Germanica</i>, unten
          mit Bleistift<i> I</i>. Den Hinterspiegel bildet das zweite Blatt eines als
          hintere Vorsatzblätter verwendeten Unio aus Papier.
       </p>
       <p class="MsoNormal"><b>Buchblock</b>: 39 x 27,5 cm,
          am Längsschnitt zwei schwarze Tintenstriche. Von Bl.
          <router-link to="/VV/001r/facsimile">1</router-link> fehlt
          oben ein gemäß stehengebliebener Buchstabenunterlägen mit Tinte beschriebener
          Streifen von 0,4–0,8 cm (siehe dazu <a href="#_Toc389816007">Kap. 2.3.2</a>). <b>Lagen</b>: II (Vorderspiegel,
          3 Vorsatzbll.) + 7 IV
          <router-link to="/VV/056v/facsimile">56</router-link>
          + (I-1)
          <router-link to="/VV/057v/facsimile">57</router-link>
          + III
          <router-link to="/VV/063v/facsimile">63</router-link>
          + 5 IV
          <router-link to="/VV/103v/facsimile">103</router-link>
          + III
          <router-link to="/VV/109v/facsimile">109</router-link>
          + (I-1)
          <router-link to="/VV/110v/facsimile">110</router-link>
          + 8 IV
          <router-link to="/VV/174v/facsimile">174</router-link>
          + (IV-1)
          <router-link to="/VV/181v/facsimile">181</router-link>
          (mit einem Nachsatzbl., Hinterspiegel). Kustoden und Reklamanten der beiden
          Schreiber am Lagendende: Schreiber I (Bl.
          <router-link to="/VV/001r/facsimile">1r</router-link>a–<router-link to="/VV/048v/facsimile">48v</router-link>b): Kustoden
          Bll.
          <router-link to="/VV/008v/facsimile">8v</router-link>:
          <i>·i<sup>9</sup>·</i>;
          <router-link to="/VV/016v/facsimile">16v</router-link>: <i>·ii·</i>;
          <router-link to="/VV/024v/facsimile">24v</router-link>: <i>·iii</i>;
          <router-link to="/VV/032v/facsimile">32v</router-link>: <i>·iiij·</i>;
          <router-link to="/VV/040v/facsimile">40v</router-link>: <i>·v<sup>9</sup>·</i> und
          <router-link to="/VV/048v/facsimile">48v</router-link>: <i>·vj·</i>;
          Reklamant: Bl.
          <router-link to="/VV/032v/facsimile">32v</router-link>.
          Schreiber II (Bl.
          <router-link to="/VV/049r/facsimile">49r</router-link>a–<router-link to="/VV/181v/facsimile">181v</router-link>b, identisch
          mit Rubrikenindikator [?]): Kustoden (ev. nicht durchwegs von Schreiber II)
          Bll.
          <router-link to="/VV/056v/facsimile">56v</router-link>:
          <i>·vii·</i>;
          <router-link to="/VV/071v/facsimile">71v</router-link>: <i>vij</i>
          (auf Rasur);
          <router-link to="/VV/079v/facsimile">79v</router-link>: <i>·viii·</i>;
          <router-link to="/VV/087v/facsimile">87v</router-link>:
          Kustode nicht mehr lesbar;
          <router-link to="/VV/095v/facsimile">95v</router-link>: <i>·x·</i>;
          <router-link to="/VV/109v/facsimile">109v</router-link>:
          <i>·<s>I</s>·</i> (von anderer Hand);
          <router-link to="/VV/110v/facsimile">110v</router-link>: <i>·<s>II</s>·</i>
          (von anderer Hand). Reklamenten Bll.
          <router-link to="/VV/056v/facsimile">56v</router-link>,
          <router-link to="/VV/063v/facsimile">63v</router-link>,
          <router-link to="/VV/109v/facsimile">109v</router-link>,
          <router-link to="/VV/110v/facsimile">110v</router-link>,
          <router-link to="/VV/118v/facsimile">118v</router-link>,
          <router-link to="/VV/126v/facsimile">126v</router-link>,
          <router-link to="/VV/134v/facsimile">134v</router-link>,
          <router-link to="/VV/142v/facsimile">142v</router-link>,
          <router-link to="/VV/150v/facsimile">150v</router-link>,
          <router-link to="/VV/158v/facsimile">158v</router-link>,
          <router-link to="/VV/166v/facsimile">166v</router-link>,
          <router-link to="/VV/174v/facsimile">174v</router-link>,
          <router-link to="/VV/176v/facsimile">176v</router-link>. Zudem
          ...
          <router-link to="/VV/064v/facsimile">64v</router-link>: <i>viij</i>;
          <router-link to="/VV/072v/facsimile">72v</router-link>: <i>ix</i>;
          <router-link to="/VV/080v/facsimile">80v</router-link>: <i>x</i>
          (m.A.);
          <router-link to="/VV/088v/facsimile">88v</router-link>:
          <i>xj</i>;
          <router-link to="/VV/096v/facsimile">96v</router-link>:
          <i>xij</i> (m.A.);
          <router-link to="/VV/104v/facsimile">104v</router-link>: <i>xiij</i>
          (m.A.);
          <router-link to="/VV/112v/facsimile">112v</router-link>:
          <i>xiiij</i> (m.A.);
          <router-link to="/VV/120v/facsimile">120v</router-link>: <i>xv</i>
          (m.A.);
          <router-link to="/VV/128v/facsimile">128v</router-link>:
          <i>xvj</i> (m.A.);
          <router-link to="/VV/136v/facsimile">136v</router-link>: <i>xvii</i>
          (m.A.);
          <router-link to="/VV/144v/facsimile">144v</router-link>:
          <i>xviij</i> (m.A.);
          <router-link to="/VV/152v/facsimile">152v</router-link>: <i>xix</i>
          (m.A.);
          <router-link to="/VV/160v/facsimile">160v</router-link>:
          <i>xx</i> (m.A.);
          <router-link to="/VV/176v/facsimile">176v</router-link>: <i>xxij</i>
          (m.A.);
          <router-link to="/VV/168v/facsimile">168v</router-link>:
          <i>xxj</i> (m.A.) (über der Zahl eine verwischte Zahl <i>xvi</i> [?]). Der
          Lagenbestimmer schreibt auf Bl.
          <router-link to="/VV/181v/facsimile">181v</router-link>b
          als Ergebnis der Zählung (insgesamt 23 Quaternionen): <span class="k"><i><s>xij j
                   quaterne</s> .</i></span><span class="ls"><i>x. quat(er)ne </i>(= 13 und 10
             Quaternionen?)</span>
                          <b>Schriftraum</b>: ca. 30,4-31 x 19,4-7 cm; zweispaltig,
          Verse abgesetzt, Versalien in eigener Spalte (0,7 cm) durch Tintenlinien
          begrenzt (29,7 [Bl.
          <router-link to="/VV/001r/facsimile">1</router-link>–<router-link to="/VV/008v/facsimile">8</router-link>] und 31
          [meist] x 9 cm, Abstand zwischen den Spalten: 1,3 cm, Abstände der Linien zu
          den Seitenrändern: oben 3 cm, unten 6,5 cm, links 2 cm, rechts 5,5 cm). Endpunkte
          (Einstichlöcher) für die Zeilen am Seitenrand außen, für die vertikale
          Liniierung oben und unter noch sichtbar, 46–48 Zeilen pro Spalte. <b>Schrift</b>:
          Textura, zwei Hände (Bl.
          <router-link to="/VV/001r/facsimile">1r</router-link>a–<router-link to="/VV/048v/facsimile">48v</router-link>b =
          Schreiber I; Bl.
          <router-link to="/VV/049r/facsimile">49r</router-link>a–<router-link to="/VV/181v/facsimile">181v</router-link>b =
          Schreiber II). <b>Ausstattung</b>: Eingangsinitiale mit filigrane Fleuroné-Initialen
          (siehe <a href="#_Toc389815985">Kap. 1.3.2</a>), rote und blaue Lombarden (Bll.
          <router-link to="/VV/001r/facsimile">1</router-link>–<router-link to="/VV/048v/facsimile">48</router-link>
          teilweise mit kleinen Buchstaben vorgeschrieben, vorgesehene zwei Zeilen nach
          Überschriften teilweise dreizeilig). ### Überschriften in roter (Bl.
          <router-link to="/VV/077v/facsimile">77v</router-link> in
          blauer) Tinte (im Folgenden mit &lt;…&gt; markiert), die Überschriften 1–4
          (Bll.
          <router-link to="/VV/003r/facsimile">3r</router-link>a,
          <router-link to="/VV/004r/facsimile">4r</router-link>a,
          <router-link to="/VV/006r/facsimile">6r</router-link>a und
          <router-link to="/VV/008v/facsimile">8v</router-link>b) von
          Schreiber I, ab Bl.
          <router-link to="/VV/011v/facsimile">11v</router-link>a bis
          zum Ende der Handschrift von Schreiber II, der die Überschriften teilweise mit
          dünner Schrift dt. oder lat. an den Rändern vorgeschrieben hat (vgl. Bl.
          <router-link to="/VV/016v/facsimile">16v</router-link>,
          ...
          drei oder sieben (Bl.
          <router-link to="/VV/073v/facsimile">73v</router-link>b)
          Zeilen werden teilweise nicht ausfüllt. Die Handschrift ist durchgängig mit
          zweizeiligen (z.T. auch drei-, zu Beginn einer letzten Zeile auch einzeilig,
          z.B. Bl.
          <router-link to="/VV/035v/facsimile">35v</router-link>b),
          alternierend in roter und blauer Farbe gemalten Lombarden mit z.T. einfachen
          Verzierungen versehen; eine Vorgabe des Buchstabens ist z.B. auf Bl.
          <router-link to="/VV/048v/facsimile">48v</router-link>b
          erkennbar. Die Lombarden sind vor den von Hand B stammenden Überschriften angefertigt
          worden (vgl. z.B. Bl.
          <router-link to="/VV/045v/facsimile">45v</router-link>a,
          <router-link to="/VV/050r/facsimile">50r</router-link>b). Rubrizierung
          der Versanfänge (Versalien) Bll.
          <router-link to="/VV/001r/facsimile">1r</router-link>–<router-link to="/VV/008v/facsimile">8v</router-link>,
          <router-link to="/VV/035r/facsimile">35r</router-link>b (Zeile
          1–23),
          <router-link to="/VV/058v/facsimile">58v</router-link>,
          <router-link to="/VV/059r/facsimile">59r</router-link>,
          <router-link to="/VV/083v/facsimile">83v</router-link>a (Zeile
          1–38) und
          <router-link to="/VV/083v/facsimile">v</router-link>b
          (Zeile 1–33), Bll.
          <router-link to="/VV/092v/facsimile">92v</router-link>–<router-link to="/VV/094r/facsimile">94r</router-link>,
          <router-link to="/VV/114v/facsimile">114v</router-link>–<router-link to="/VV/115r/facsimile">115r</router-link>,
          <router-link to="/VV/123v/facsimile">123v</router-link>–<router-link to="/VV/124r/facsimile">124r</router-link>,
          <router-link to="/VV/130v/facsimile">130v</router-link>–<router-link to="/VV/131r/facsimile">131r</router-link>,
          <router-link to="/VV/145v/facsimile">145v</router-link>,
          <router-link to="/VV/146v/facsimile">146v</router-link>–<router-link to="/VV/147v/facsimile">147v</router-link>,
          <router-link to="/VV/148v/facsimile">148v</router-link>–<router-link to="/VV/159v/facsimile">159v</router-link>
          (lediglich die Versoseiten),
          <router-link to="/VV/160r/facsimile">160r</router-link>–<router-link to="/VV/160v/facsimile">v</router-link>.
          ...
          <router-link to="/VV/026v/facsimile">26v</router-link>b: <span class="titel1"><i><s>ſ</s></i></span><i><s>pringen</s></i> <span class="titel1"><i>ſ</i></span><i>ingen</i>)
          und schwarzer (z.B Bl.
          <router-link to="/VV/059v/facsimile">59v</router-link>a)
          Tinte oder durch Verweiszeichen (z.B. Bl.
          <router-link to="/VV/032v/facsimile">32v</router-link>a).
          Vereinzelt Korrekturen von anderer, spät. Hand (z.B. Bl.
          <router-link to="/VV/072v/facsimile">72v</router-link>b). Bl.
          <router-link to="/VV/005r/facsimile">5r</router-link>:
          Markierung (schwarze Tinte) der Verse NP 741–776 mit Strich entlang der Spalte
          sowie mit Zeigehand; Bl.
          <router-link to="/VV/008v/facsimile">8v</router-link>b und
          <router-link to="/VV/013r/facsimile">13r</router-link>a
          jeweils zwei Griffelkreuze; Bl.
          <router-link to="/VV/014r/facsimile">14r</router-link>,
          unterer Rand, mitte, schwarze Tinte: <i>M</i> oder <i>III</i> (?); Bl.
          <router-link to="/VV/057v/facsimile">57v</router-link>b bemerkter
          und durch Streichung korrigierter Augensprung; Bl.
          <router-link to="/VV/061r/facsimile">61r</router-link>b:
          Vers nachgetragen; Bl.
          <router-link to="/VV/063v/facsimile">63v</router-link>
          Notiz von der Schreiberhand II: <i>die erst</i> (neben der Kustode); Bl.
          <router-link to="/VV/080r/facsimile">80r</router-link>
          Schraffur am Rand; Bl.
          <router-link to="/VV/090r/facsimile">90r</router-link>b:
          Zwei Verse gestrichen; Bl.
          <router-link to="/VV/096v/facsimile">96v</router-link>
          unleserlicher Randeintrag; Bl.
          <router-link to="/VV/126r/facsimile">126r</router-link> auf
          Höhe der Lagenbestimmungen: <i>e<span class="titel1">ſ</span>t</i> (?); Bl.
          <router-link to="/VV/148v/facsimile">148v</router-link>,
          linker Rand: Unvollständige Zeichnung mit Tinte: Kübelhelm mit Helmzier (Hörner)
          und Helmdecke; Bl.
          <router-link to="/VV/150r/facsimile">150r</router-link>:
          Kreis am Rand; Bl.
          <router-link to="/VV/177r/facsimile">177r</router-link>
          Kreuz am Rand. <b>Zustand</b>: Pergament teilweise fleckig, großer Tintenfleck
          auf Bl.
          <router-link to="/VV/111r/facsimile">111r</router-link>b
          und
          <router-link to="/VV/112v/facsimile">112v</router-link>a
          (mit Textverlust), Risse und Löcher im Pergament vor der Beschriftung teilweise
          genäht, Fäden verloren (vgl. Bll.
          <router-link to="/VV/058r/facsimile">58</router-link>,
          <router-link to="/VV/060r/facsimile">60</router-link>,
          <router-link to="/VV/067r/facsimile">67</router-link>,
          <router-link to="/VV/087r/facsimile">87</router-link>,
          <router-link to="/VV/136r/facsimile">136</router-link>,
          <router-link to="/VV/142r/facsimile">142</router-link>,
          <router-link to="/VV/170r/facsimile">170</router-link> und
          <router-link to="/VV/172r/facsimile">172</router-link>), letztes
          Papierblatt des ersten Binio verso verschmutzt durch Abdruck Stempel auf Bl.
          <router-link to="/VV/001r/facsimile">1r</router-link> am
          Rand.
       </p>
       <p class="MsoNormal"><b>Schreibsprache</b>:
          Niederalemannisch.<a href="#_ftn127" id="_ftnref127"><sup>[127]</sup></a></p>
       <h5><a id="_Toc389816000"></a>2.1.2 Inhalt</h5>
       <div class="contentbox-left"></div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/001r/facsimile">1r</router-link>a
       </div>
       <div class="contentbox-right"><b>Prosaüberleitung
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/001r/facsimile">1r</router-link>a–<router-link to="/VV/001r/facsimile">1r</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/001r/facsimile">1r</router-link>b–<router-link to="/VV/171r/facsimile">171r</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/001r/facsimile">1r</router-link>b–<router-link to="/VV/006r/facsimile">6r</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/006r/facsimile">6r</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/006r/facsimile">6r</router-link>b–<router-link to="/VV/036v/facsimile">36v</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/036v/facsimile">36v</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/036v/facsimile">36v</router-link>b–<router-link to="/VV/040v/facsimile">40v</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/040v/facsimile">40v</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/040v/facsimile">40v</router-link>a–<router-link to="/VV/051v/facsimile">51v</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/051v/facsimile">51v</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/051v/facsimile">51v</router-link>b–<router-link to="/VV/066r/facsimile">66r</router-link>a
       </div>
       <div class="contentbox-right">[2.9]
          <b>›Première Continuation‹</b>, Mischredaktion, Ep. V,4 und V, 6–8, dt. (Roach
          I, 13425–13852) (NP 9669–12493; Sch. 217.30–281.7) (um die 100 Minusverse
          gegenüber V):<a href="#_ftn128" id="_ftnref128"><sup>[128]</sup></a> <i>Nv er ein wenic geruwet
             hette<span class="ras">… – …Do wart er gehei</span>ſzen dedimaz</i></div>
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/066r/facsimile">66r</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/066r/facsimile">66r</router-link>a–<router-link to="/VV/073v/facsimile">73v</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/073v/facsimile">73v</router-link>a–b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/073v/facsimile">73v</router-link>b–<router-link to="/VV/079v/facsimile">79v</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/079v/facsimile">79v</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/079v/facsimile">79v</router-link>a–<router-link to="/VV/134v/facsimile">134v</router-link>a
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/134v/facsimile">134v</router-link>a–<router-link to="/VV/171r/facsimile">171r</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/171r/facsimile">171r</router-link>b–<router-link to="/VV/179v/facsimile">179v</router-link>b
       </div>
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/VV/171r/facsimile">171r</router-link>b–<router-link to="/VV/174v/facsimile">174v</router-link>a [2.19.1]
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/VV/174v/facsimile">174v</router-link><span lang="EN-US">a [2.19.2] <b>Einschub: ›Troisième
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/VV/174v/facsimile">174v</router-link>a [2.19.3]
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/VV/174v/facsimile">174v</router-link>a–b
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/VV/174v/facsimile">174v</router-link>b–<router-link to="/VV/175r/facsimile">175r</router-link><span lang="EN-US">a [2.19.5] <b>Einschub: ›Troisième
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/VV/175r/facsimile">175r</router-link>a–<router-link to="/VV/176r/facsimile">176r</router-link><span lang="EN-US">a [2.19.6] <b>Wolframs ›Parzival‹,
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/VV/176r/facsimile">176r</router-link>a [2.19.7]
          <b>Einschub: ›Troisième Continuation‹</b>, Ep. 29 und 30, dt. (Roach V, 42464–42468
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/VV/176v/facsimile">176v</router-link>a [2.19.11]
          <b>Einschub</b> (L. 789.2<sup>1–2</sup>; Sch. LIV): <i>Vnd kunig artus der
             riche | Vnd ſie alleſamt geliche</i></div>
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/VV/176v/facsimile">176v</router-link>a–
          <router-link to="/VV/177r/facsimile">177r</router-link>a [2.19.12]
          <b>Wolframs ›Parzival‹, Buch XVI</b> (L. 789.3–793.28): <i>Mit freude uf
             Muntſchalfaſche riten… – …Den ſwarczen vnd den wiſen</i></div>
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/VV/177r/facsimile">177r</router-link>a [2.19.13]
          <b>Einschub</b> (L. 793.28<sup>1-2</sup>; Sch. LIV): <i>Vnd die tauelrunder
             alle gar | Die mit artuſe waren kome(n) dar</i></div>
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/VV/177r/facsimile">177r</router-link><span lang="EN-US">a–</span><router-link to="/VV/178v/facsimile">178v</router-link><span lang="EN-US">b [2.19.14] <b>Wolframs ›Parzival‹,
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/VV/178v/facsimile">178v</router-link>b–<router-link to="/VV/179r/facsimile">179r</router-link>b [2.19.15]
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/VV/179r/facsimile">179r</router-link>b–
          <router-link to="/VV/179v/facsimile">v</router-link>a [2.19.16]
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/VV/179v/facsimile">179v</router-link><span lang="EN-US">a [2.19.17] <b>Einschub: ›Troisième
       ...
       <div style="clear:both"></div>
       <div class="contentbox-right">
          <router-link to="/VV/179v/facsimile">179v</router-link>a–b [2.19.18]
          <b>Wolframs ›Parzival‹, Buch XVI</b> (L. 823.11-a–827.30): <i>Ouch ſage ich uch
             von lohelagrin… – …Die mvz mir ſuſzer worte iehen</i></div>
       <div style="clear:both"></div>
       <div class="contentbox-left">
          <router-link to="/VV/179v/facsimile">179v</router-link>b–<router-link to="/VV/181v/facsimile">181v</router-link>b
       </div>
       ...
       <h4><a id="_Toc389816001"></a><a id="_Ref379010758"></a>2.2 Genese der der Handschrift V'
       </h4>
       <p class="MsoNormal">Im Gegensatz zur Genese von Hs. V
          ...
          eröffnete einen Einblick in den Entstehungskontext von Hs. V'.<a href="#_ftn129" id="_ftnref129"><sup>[129]</sup></a>
       </p>
       <h5><a id="_Toc389816002"></a>2.2.1 Schreiber</h5>
       <p class="MsoNormal">Von dem ersten der beiden am
          Codex beteiligten Schreiber<a href="#_ftn130" id="_ftnref130"><sup>[130]</sup></a> stammen das Initium der
          Eingangsseite in roter Tinte (Bl.
          <router-link to="/VV/001r/facsimile">1r</router-link>a)
          sowie die ersten sechs mit schwarzer Tinte beschriebenen Lagen (Bl.
          <router-link to="/VV/001r/facsimile">1r</router-link>a–<router-link to="/VV/048v/facsimile">48v</router-link>b),
          die er jeweils mit römischen Ziffern numeriert. Auf Bl.
          <router-link to="/VV/049r/facsimile">49r</router-link>a
          setzt auf einer neuen Lage der zweite Schreiber ein und kopiert den restlichen
          Text, wobei er die Lagen ebenfalls mit römischen Ziffern nummeriert. Die vier
          ersten (Bl.
          <router-link to="/VV/003r/facsimile">3r</router-link>a,
          <router-link to="/VV/004r/facsimile">4r</router-link>a,
          <router-link to="/VV/006r/facsimile">6r</router-link>a und
          <router-link to="/VV/008v/facsimile">8v</router-link>b) der
          roten Überschriften sind von der ersten Schreiberhand verantwortet, die
          wahrscheinlich auch die bis Bl.
          <router-link to="/VV/008v/facsimile">8v</router-link>
          reichende Rubrizierung ausgeführt hat.
       </p>
       <p class="MsoNormal">                Wie ein
          Schriftvergleich ergeben hat,<a href="#_ftn131" id="_ftnref131"><sup>[131]</sup></a> handelt es sich bei der
          ...
          mit wenigen, begründbaren Ausnahmen derjenigen des ersten Schreibers von Hs. V'.<a href="#_ftn132" id="_ftnref132"><sup>[132]</sup></a>
          Die zweite Schreiberhand von V' kann in diesem Skriptorium nicht nachgewiesen
          werden.
       </p>
       <h5>
                          <a id="_Toc389816003"></a>
                          <a id="_Ref379124988"></a>
                          <a id="_Ref379124893"></a>2.2.2 Buchschmuck
       </h5>
       <p class="MsoNormal">Auch die Eingangsinitiale <i>W</i> mit blaurot gespaltenem
          ...
          Handschriften des genannten Skriptoriums zugewiesen werden.<a href="#_ftn133" id="_ftnref133"><sup>[133]</sup></a></p>
       <h5>
                          <a id="_Toc389816004"></a>
                          <a id="_Ref379046729"></a>2.2.3 Die nordfränkische ‘Epenwerkstatt’
       </h5>
       <p class="MsoNormal">Aus diesem von <span style="font-variant:small-caps">Karin Schneider</span> ‘Epenwerkstatt’ genannten
          Skriptorium haben sich sieben großformatige, zweispaltige Codices mit nahezu
          identischer Größe erhalten (Maßangaben gerundet):<a href="#_ftn134" id="_ftnref134"><sup>[134]</sup></a></p>
       <table style="border:0">
          <colgroup>
             <col/>
             <col style="width:10rem"/>
          ...
          <tbody>
             ...
             <tr>
                <td>
                   <router-link to="/VV/001r/facsimile">Roma, Biblioteca Casanatense, Ms. 1409</router-link> (V')
                </td>
                <td>≥ 39 x 27</td>
                <td>29–32 x 19–20</td>
       ...
       <p class="MsoNormal">Abgesehen von der Identität der
          ...
          lässt sich dieses Skriptorium nicht genauer bestimmen.<a href="#_ftn135" id="_ftnref135"><sup>[135]</sup></a>
          ...
          lässt sich ebenfalls nicht beantworten.<a href="#_ftn136" id="_ftnref136"><sup>[136]</sup></a></p>
       <h4><a id="_Toc389816005"></a><a id="_Ref379010814"></a>2.3 <span class="MsoPageNumber">Besitzgeschichte</span> der Handschrift V'
       </h4>
       ...
       <h5>
                          <a id="_Toc389816006"></a>2.3.1 Lamprecht von Brun als Besitzer von V'?
       </h5>
       <p class="MsoNormal">Als früher Besitzer der Sammlung,
          ...
          de Buren, von Buren, de Fonte) vermutet.<a href="#_ftn137" id="_ftnref137"><sup>[137]</sup></a> Grund für diese Annahme
          ...
          gestifteten Spitals in Scheßlitz für 350 Gulden<i>
                             </i>an den römischen König
          Ruprecht von der Pfalz verkauft worden waren.<a href="#_ftn138" id="_ftnref138"><sup>[138]</sup></a>
          ...
          Bamberg) über,<a href="#_ftn139" id="_ftnref139"><sup>[139]</sup></a> das allerdings keine
          »Bibliothek, die diesen Namen verdienen würde«, besaß.<a href="#_ftn140" id="_ftnref140"><sup>[140]</sup></a>
          Lamprechts heute verstreute, laut <span style="font-variant:small-caps">Joseph</span> <span style="font-variant:small-caps">Heller</span> »sehr bedeutende
          Bibliothek«<a href="#_ftn141" id="_ftnref141"><sup>[141]</sup></a> ist über die Jahre
       ...
       <p class="Standartpetit">Der aus einem elsässischen niederadeligem Geschlecht
          ...
          Juli verstarb.<a href="#_ftn142" id="_ftnref142"><sup>[142]</sup></a> Bereits im
          ...
          mit dem ›Apparatus in quinque libros decretalium‹ Innocents IV.<a href="#_ftn143" id="_ftnref143"><sup>[143]</sup></a>
          Eine weitere, ebenfalls aus Oberitalien stammende Dekretalenhandschrift aus dem
          4. Viertel des 13. Jahrhunderts kaufte Lamprecht vermutlich in Gengenbach.<a href="#_ftn144" id="_ftnref144"><sup>[144]</sup></a>
          ...
          possessionum<span lang="IT">‹</span>)<a href="#_ftn145" id="_ftnref145"><sup>[145]</sup></a> sowie Teile einer im
          ...
          Armenbibel des 15. Jahrhunderts zusammengebunden wurde.<a href="#_ftn146" id="_ftnref146"><sup>[146]</sup></a>
          ...
          Leibarzt Karls IV., von denen <span lang="IT">Johannes des Gaddesden ›Rosa
             anglica medicinae‹ aus dem Jahr 1368 stammt.</span><a href="#_ftn147" id="_ftnref147"><sup>[147]</sup></a></p>
       ...
       <h5><a id="_Toc389816007"></a><a id="_Ref381895864"></a><a id="_Ref379125906"></a>2.3.2 V' – Der Cod. Pal. germ. 317 der Heidelberger Palatina</h5>
       <p class="MsoNormal">Wie <span style="font-variant: small-caps">Matthias Miller</span> 2007 als erster bemerkt hat, zählte Hs. V' spätestens
          ...
          Signatur Cod. Pal. germ. 317 aufbewahrt wurde.<a href="#_ftn148" id="_ftnref148"><sup>[148]</sup></a>
          In einem Eintrag im älteren Katalog der Heidelberger Schlossbibliothek von 1581<a href="#_ftn149" id="_ftnref149"><sup>[149]</sup></a> erscheint Hs. V'
       ...
       <p class="Standartpetit" style="margin:0cm;margin-bottom:.0001pt">[Nr. 2]
          Parcefall vnd Lorangrin, alte reymen. geſchriben perm.| gleiches bunds<a href="#_ftn150" id="_ftnref150"><sup>[150]</sup></a></p>
       <p class="Standartpetit" style="margin:0cm;margin-bottom:.0001pt">[Nr. 3] Der Welſch
          Parcefall vnd Galein. Perme&#x0304;t reime&#x0304;. | bret. braun led(er)<a href="#_ftn151" id="_ftnref151"><sup>[151]</sup></a></p>
       <p class="Standartpetit" style="margin:0cm;margin-bottom:.0001pt">[Nr. 4] Der
          Titterel. geſchrieben Perment. gleiches bunds<a href="#_ftn152" id="_ftnref152"><sup>[152]</sup></a></p>
       ...
       <p class="Standartpetit" style="margin-top:0cm">[Nr. 6] Margraúe Wilhelms von
          Cranitʒ búch. Reimen | geſchrieben Perment. gleiches búnds.<a href="#_ftn153" id="_ftnref153"><sup>[153]</sup></a></p>
       <p class="MsoNormal">Im Dreissigjährigen Krieg wurde
          ...
          <router-link to="/VV/001r/facsimile">1r</router-link>,
          oberer Rand) nach Rom, wo sie die Signatur <i>1248</i> (siehe Bl.
          <router-link to="/VV/001r/facsimile">1r</router-link>,
          oberer Rand) erhielt<a href="#_ftn154" id="_ftnref154"><sup>[154]</sup></a> und um die Mitte des
          17. Jahrhunderts neu gebunden wurde.<a href="#_ftn155" id="_ftnref155"><sup>[155]</sup></a> Als Vorsatzblätter
          ...
          Heidelberger Palatina verwendet wurde.<a href="#_ftn156" id="_ftnref156"><sup>[156]</sup></a> Bis in die zweite Hälfte
          des 18. Jahrhunderts wurde die Hs. V' mit den anderen Codices aus der Palatina
          in der Vaticana aufbewahrt.<a href="#_ftn157" id="_ftnref157"><sup>[157]</sup></a></p>
       <h5><a id="_Toc389816008"></a>2.3.3 Heutiger Standort von V': Die Biblioteca Casanatense in Rom</h5>
       <p class="MsoNormal">Erst im Jahr 1816 gelangten nach
          ...
          Umständen gelangte diese zwischen 1751 und 1792 in die im Jahr 1701 neu
          eröffnete Bibliothek des Römischen Dominikanerkonvents bei Santa Maria sopra
          Minerva, der heutigen Biblioteca Casanatense, wo die Handschrift die Signatur <i>AR.
             I. 9. </i>(doppelt durchgestrichen), später <i>I A. I. 19.</i> (<i>I</i> =
          doppelt durchgestrichen) und schließlich die heute gültige Signatur <i>Cod.
             1409</i> (siehe Vorderspiegel) erhielt.<a href="#_ftn158" id="_ftnref158"><sup>[158]</sup></a></p>
       ...
       <blockquote class="Blockquote">»In dem handschriftlichen Verzeichnisse der Handschriften fand ich eine einzige
          ...
          Druck in Zürich getroffen hatte.«<a href="#_ftn159" id="_ftnref159"><sup>[159]</sup></a>
       </blockquote>
       <h3><a id="endOfText"></a></h3>
       <div class="footnotes">
          ...
          <div id="ftn3">
             <p class="MsoFootnoteText"><a href="#_ftnref3" id="_ftn3"><sup>[3]</sup></a>          <span style="">Die
                   Verse der afr. Vorlagen werden zitiert mit dem Kürzel „CdGr“ nach <span style="font-variant:small-caps">Chrétien,
                      ›Conte du Graal‹ (Ed. </span></span><span lang="EN-US" style=" font-variant:small-caps">Busby), </span><span lang="EN-US" style="">und
                   als Roach I, II und V
                   (Fortsetzungen) nach <span style="font-variant:small-caps">›Perceval‹, First
                      Continuation (Ed. Roach), ›Perceval‹, Second Continuation (Ed. </span></span><span style="font-variant:small-caps">Roach),</span><span style=""> und <span style="font-variant:small-caps">›Perceval‹,
          ...
          <div id="ftn5">
             <p class="MsoFootnoteText"><a href="#_ftnref5" id="_ftn5"><sup>[5]</sup></a>          <span style="">Kritischer
                   hingegen lesen den Epilog </span><span style="font-family:&#34;d&#34;,&#34;serif&#34;; font-variant:small-caps">Wolfgang Achnitz</span><span style="">,
          ...
          <div id="ftn7">
             <p class="MsoFootnoteText"><a href="#_ftnref7" id="_ftn7"><sup>[7]</sup></a>          <span style="">Vgl.
                   <span style="font-variant:small-caps">Schorbach</span> (1888), S. XI, Zit. ebd.
                   (Hervorhebung im Original).</span></p>
          </div>
          <div id="ftn8">
             <p class="MsoFootnoteText"><a href="#_ftnref8" id="_ftn8"><sup>[8]</sup></a>          <span style="">Vgl.
                   <span style="font-variant:small-caps">Viehhauser-Mery</span> (2009), S. 113,
                   Zit. ebd.</span></p>
          </div>
          <div id="ftn9">
             <p class="MsoFootnoteText"><a href="#_ftnref9" id="_ftn9"><sup>[9]</sup></a>          <span style="">Die
                   Lagenformel folgt der Beschreibung von <span style="font-variant:small-caps">Ute
                      Obhof</span> auf der Internet-Plattform ‚</span><a href="http://www.manuscripta-mediaevalia.de/?xdbdtdn!%22obj%2031576740%22&amp;dmode=doc#|4"><span style="">Manuscripta Mediaevalia</span></a><span style="">’.</span></p>
          </div>
          <div id="ftn10">
             <p class="MsoFootnoteText"><a href="#_ftnref10" id="_ftn10"><sup>[10]</sup></a>         <span style="">Nach <span style="font-variant:small-caps">Schneider</span> (2009), Textbd., S. 140,
                   lediglich zwei Schreiber. Zur Charakterisierung siehe ebd., S. 141.</span></p>
          </div>
          <div id="ftn11">
             <p class="MsoFootnoteText"><a href="#_ftnref11" id="_ftn11"><sup>[11]</sup></a> Zu
                   den Dialektmerkmalen siehe <span style="font-variant:small-caps">Hartl</span>
                   (1928), S. 8–17.</p>
          </div>
          <div id="ftn12">
             <p class="MsoFootnoteText"><a href="#_ftnref12" id="_ftn12"><sup>[12]</sup></a>         <span style="">Die
                   ...
                   *T-Fassung siehe <span style="font-variant:small-caps">Schöller</span> (2009).</span></p>
          </div>
          <div id="ftn13">
             <p class="MsoFootnoteText"><a href="#_ftnref13" id="_ftn13"><sup>[13]</sup></a>         <span style="">In L.
                   ...
                   bei <span style="font-variant:small-caps">Schorbach</span> (1888), S. XLIX.</span></p>
          </div>
          <div id="ftn14">
             <p class="MsoFootnoteText"><a href="#_ftnref14" id="_ftn14"><sup>[14]</sup></a>         <span style="">Zu
                   dieser und zu den folgenden Abkürzungen der Textausgaben siehe das
                   ###Abkürzungsverzeichnis.</span></p>
          </div>
          <div id="ftn15">
             <p class="MsoFootnoteText"><a href="#_ftnref15" id="_ftn15"><sup>[15]</sup></a>         <span style=" font-variant:small-caps">Emmerling</span><span style=""> (2003),
                   S. 32.</span></p>
          </div>
          <div id="ftn16">
             <p class="MsoFootnoteText"><a href="#_ftnref16" id="_ftn16"><sup>[16]</sup></a>         <span style="">Das
                   ...
                   altfr. Dichtung des 12. Jahrhunderts personifiziert; vgl. <span style="font-variant:small-caps">Herzhoff</span> (1904), S. 30f. (Nr. 15).</span></p>
          </div>
          <div id="ftn17">
             <p class="MsoFootnoteText"><a href="#_ftnref17" id="_ftn17"><sup>[17]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Wittmann-Klemm</span> (1977), S. 111–120, und <span style="font-variant:small-caps">Emmerling</span> (2003), S. 36.</span></p>
          </div>
          <div id="ftn18">
             <p class="MsoFootnoteText"><a href="#_ftnref18" id="_ftn18"><sup>[18]</sup></a>         <span style="">Siehe
          ...
          <div id="ftn19">
             <p class="MsoFootnoteText"><a href="#_ftnref19" id="_ftn19"><sup>[19]</sup></a>         <i><span style="">der
                      </span></i><span style="">[<i>schilte</i>]<i> ist so rich
                   ...
                   der Bände des </span><a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f15.image.r=.langDE"><span style="">RUB</span></a><span style="">) sowie auf
                   der um 1330–1345 im Bodenseeraum entstandenen ›Zürcher Wappenrolle‹ (Zürich,
                   SNM, AG 2760, Bl. </span><a href="https://www.e-codices.unifr.ch/de/snm/AG002760/3v/0/Sequence-1329"><span style="">3v</span></a><span style="">, untere
                   Reihe, achtes Wappen von links; vgl. das Volldigitalisat auf </span><a href="http://www.e-codices.unifr.ch/de/snm/AG002760/3v/0/Sequence-1329"><span style="">e-codices.ch</span></a><span style="">.</span></p>
          </div>
          <div id="ftn20">
             <p class="MsoFootnoteText"><a href="#_ftnref20" id="_ftn20"><sup>[20]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Backes</span> (2009), S. 5. – Im Minnebrief der
                   <i>Minne</i> an das Herz Ulrichs von Rappoltstein heißt es: <i>Kv́nig artus
                      muͤſte din mog ſin | Wan er oͮch ſine ſtu(n)de | Do mitte kv́rzen begunde | Daz
                      er leſendez ſich gewag</i> (L. 827.30<sup>210–213</sup>; Sch. 850.24–27).</span></p>
          </div>
          <div id="ftn21">
             <p class="MsoFootnoteText"><a href="#_ftnref21" id="_ftn21"><sup>[21]</sup></a>         <i><span style="">Daz
                      ...
                      waz</span></i><span style=""> (L. 827.30<sup>198–204</sup>; Sch.
          ...
          <div id="ftn22">
             <p class="MsoFootnoteText"><a href="#_ftnref22" id="_ftn22"><sup>[22]</sup></a>         <i><span style="">Kv́nig
                      artus muͤſte din mog ſin</span></i><span style=""> (L. 827.30<sup>210</sup>;
                   Sch. 850.24); <i>Dar an biſt du ſin genoz | Du heſt von imme geerbet daz</i>
                   (L. 827.30<sup>216f.</sup>; Sch. 850.30f.).</span></p>
          </div>
          <div id="ftn23">
             <p class="MsoFootnoteText"><a href="#_ftnref23" id="_ftn23"><sup>[23]</sup></a>         <span style=" font-variant:small-caps">Emmerling</span><span style=""> (2003),
                   S. 45.</span></p>
          </div>
          <div id="ftn24">
             <p class="MsoFootnoteText"><a href="#_ftnref24" id="_ftn24"><sup>[24]</sup></a>         <i><span style="">Von
                      Rapolzſtein edelre vͦlrich</span></i><span style=""> (L. 827.30<sup>167</sup>;
                   Sch. 849.28); <i>frúnt min ropoltſteiner</i> (L. 827.30<sup>192</sup>; Sch.
                   850.6); <i>vͦlrich von Ropoltzſteine</i> (L. 827.30<sup>331</sup>; Sch. 853.8);
                   <i>vͦlrich</i> (L. 827.30<sup>338</sup>; Sch. 853.16); <i>der herre fri</i> (L.
          ...
          <div id="ftn25">
             <p class="MsoFootnoteText"><a href="#_ftnref25" id="_ftn25"><sup>[25]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Rathgeber</span> (1874), S. 2 und 10–14; <span style="font-variant:small-caps">Brieger</span> (1907), S. 22; <span style="font-variant:small-caps">Kreutz</span> (2005); <span style="font-variant: small-caps">Zeilinger</span> (2012a); <span style="font-variant:small-caps">Zeilinger</span>
                   ...
                   bei </span><a href="http://docnum.univ-lorraine.fr/public/DDOC_T_2012_0138_KOCH_VOL2.pdf"><span style="font-variant:small-caps">Koch</span><span style=""> (2012)</span></a><span style="">, S.
                   68–80.</span></p>
          </div>
          <div id="ftn26">
             <p class="MsoFootnoteText"><a href="#_ftnref26" id="_ftn26"><sup>[26]</sup></a>         <span style="">Die
                   ...
                   weichen teilweise von denjenigen in der Literatur ab; vgl. Register RUB I, S. </span><a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f687.image.r=.langDE"><span style="">661</span></a><span style="">f.; <span style="font-variant:small-caps">Oberbadisches Geschlechterbuch</span> 3, S. 335
                   (Tafel I), sowie <span style="font-variant:small-caps">Stammtafeln</span> XI,
                   Tafel 81. Die Namensbezeichnungen mit und ohne Nummerierung (zweimal <span style="letter-spacing:1.0pt">Ulrich</span> [Nrn. 1 und] und <span style="letter-spacing:1.0pt">Ulrich IV.</span> [Nr. 3]) folgen den <span style="font-variant:small-caps">Stammtafeln</span>.</span></p>
          </div>
          <div id="ftn27">
             <p class="MsoFootnoteText"><a href="#_ftnref27" id="_ftn27"><sup>[27]</sup></a>
          ...
          <div id="ftn28">
             <p class="MsoFootnoteText">
                                    <a href="#_ftnref28" id="_ftn28">
                                           <sup>[28]</sup>
                                       </a>
                                    <span lang="EN-US" style="">RUB I, S. 337, Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f363.item.r=">
                                           <span lang="EN-US" style="">455</span>
                                       </a>
                                    <span lang="EN-US" style=""> (11.2.1335), S. 340, Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f366.image.r=.langDE">
                                           <span style="">459</span>
                                       </a>
                                    <span style="">
                   (16.7.1335), S. 340f., Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f366.image.r=.langDE">
                                           <span style="">460</span>
                                       </a>
                                    <span style="">
                   (7.8.1335), S. 341, Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f367.image.r=.langDE">
                                           <span style="">461</span>
                                       </a>
                                    <span style="">
                   (22.8.1335), S. 372–375, Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f398.image.r=.langDE">
                                           <span style="">498</span>
                                       </a>
                                    <span style=""> (8.6.1338)
                   und S. 375f., Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f401.image.r=.langDE">
                                           <span style="">499</span>
                                       </a>
                                    <span style="">
                   (8.6.1338). Bereits zwischen 1313 und 1321 ist ohne nähere Bezeichnung ein
                   Ulrich von Rappoltstein als Domherr in Straßburg belegt, bei dem es sich
                   möglicherweise um Ulrich IV. (Nr. 3) handelt; vgl. RUB I, S. 221, Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f247.image.r=.langDE">
                                           <span style="">306</span>
                                       </a>
                                    <span style=""> (6.5.1313),
                   S. 253f., Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f279.image.r=.langDE">
                                           <span style="">344</span>
                                       </a>
                                    <span style="">
                   (2.5.1318); SUB II 2, S. 319f., Nr. </span>
                                    <a href="https://archive.org/stream/urkundenundakte03wincgoog#page/n333/mode/2up">
                                           <span style="">363</span>
                                       </a>
                                    <span style=""> (2.5.1318),
                   hier S. 320, Anm. 1, und SUB III, S. 287, Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k9401049b/f339.image.r=Urkundenbuch%20der%20Stadt%20Strassburg%20dritter">
                                           <span style="">952</span>
                                       </a>
                                    <span style="">
                   (15.1.1321).</span>
          ...
          <div id="ftn29">
             <p class="MsoFootnoteText">
                                    <a href="#_ftnref29" id="_ftn29">
                                           <sup>[29]</sup>
                                       </a>
                                    <span lang="EN-US" style="">Vgl. RUB I, S. 289f., Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f315.image.r=.langDE">
                                           <span style="">397</span>
                                       </a>
                                    <span style="">
                   (14.10.1328), S. 372–375, Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f398.image.r=.langDE">
                                           <span style="">498</span>
                                       </a>
                                    <span style="">
                   (8.6.1338), S. 375f., Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f401.image.r=.langDE">
                                           <span style="">499</span>
                                       </a>
                                    <span style="">
                   ...
                   (2011), S. 367 (Nr. 161, wo <span style="font-variant:small-caps">Buchheit</span>
          ...
          <div id="ftn30">
             <p class="MsoFootnoteText">
                                    <a href="#_ftnref30" id="_ftn30">
                                           <sup>[30]</sup>
                                       </a>
                                    <span lang="EN-US" style="">Vgl. RUB I, S. 354–357, Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f380.image.r=.langDE">
                                           <span style="">480</span>
                                       </a>
                                    <span style="">
                   (10.5.1337), und S. 599, Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f625.image.r=.langDE">
                                           <span style="">770</span>
                                       </a>
                                    <span style=""> (Nachtrag,
                   eigentlich 515<sup>bis</sup>) (1340), S. 354–357.</span>
             </p>
          </div>
          <div id="ftn31">
             <p class="MsoFootnoteText"><a href="#_ftnref31" id="_ftn31"><sup>[31]</sup></a>         Karlsruhe, Landesarchiv
          ...
          <div id="ftn32">
             <p class="MsoFootnoteText"><a href="#_ftnref32" id="_ftn32"><sup>[32]</sup></a>                                       <span style="">Vgl. <span style="font-variant:small-caps">Riezler</span>
                   ...
                   1, S. </span><a href="http://digi.ub.uni-heidelberg.de/diglit/kindlervonknobloch1898bd1/0407/image"><span style="">403</span></a><span style=""> (Grafen
          ...
          <div id="ftn33">
             <p class="MsoFootnoteText"><a href="#_ftnref33" id="_ftn33"><sup>[33]</sup></a>         <span style="">Zur
          ...
          <div id="ftn34">
             <p class="MsoFootnoteText">
                                    <a href="#_ftnref34" id="_ftn34">
                                           <sup>[34]</sup>
                                       </a>
                                    <span lang="EN-US" style="">Vgl. RUB I, S. 372–375 (Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f398.item.r=">
                                           <span style="">498</span>
                                       </a>
                                    <span style="">)
                   (8.6.1338) und S. 375f. (Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f401.item.r=">
                                           <span style="">499</span>
                                       </a>
                                    <span style="">)
                   ...
                   nach England antreten musste; Vgl. </span>
                                    <span lang="EN-US" style="">RUB I, S. 395–398 (Nr. </span>
          ...
          <div id="ftn35">
             <p class="MsoFootnoteText"><a href="#_ftnref35" id="_ftn35"><sup>[35]</sup></a>         Siehe
                   dazu auch <span style="font-variant:small-caps">Schorbach</span> (1888), S. XX.</p>
          </div>
          <div id="ftn36">
             <p class="MsoFootnoteText"><a href="#_ftnref36" id="_ftn36"><sup>[36]</sup></a>         Vgl. <span style="font-variant:small-caps">Scholz</span> (1987), S. 97, Anm. 3.</p>
          </div>
          <div id="ftn37">
             <p class="MsoFootnoteText"><a href="#_ftnref37" id="_ftn37"><sup>[37]</sup></a>         Alſus ſint fúnf ior oder me | Obe
                diſem buͦche verzert (L. 827.30<sup>380f.</sup>; Sch. 854.12f.); &lt;Diz ſol
                nieman v(er)geſſen | Ob diſem buͦche ſint fúnf ior geſeſſen | Ze tihtende vn(d)
                ze ſchriben | Hie ſol ein ende bliben&gt; (L. 827.30<sup>562–565</sup>; Sch. <span lang="EN-US">XVI).</span></p>
          </div>
          <div id="ftn38">
             <p class="MsoFootnoteText">
                                    <a href="#_ftnref38" id="_ftn38">
                                           <sup>[38]</sup>
                                       </a>
                                    <span lang="EN-US" style="font-variant:small-caps">Schorbach</span>
                                    <span lang="EN-US" style=""> (1888), S. XXII.</span>
             </p>
          </div>
          <div id="ftn39">
             <p class="MsoFootnoteText">
                                    <a href="#_ftnref39" id="_ftn39">
                                           <sup>[39]</sup>
                                       </a>
                                    <span lang="EN-US" style="">Vgl. RUB I, S. 307f. (Nr. </span>
          ...
          <div id="ftn40">
             <p class="MsoFootnoteText">
                                    ...
                                    <span lang="EN-US" style="">RUB I, S. 325f. (Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k94010463/f351.item.r=">
          ...
          <div id="ftn41">
             <p class="MsoFootnoteText">
                                    ...
                                    <span lang="EN-US" style="">RUB I, S. 335f. (Nr. </span>
          ...
          <div id="ftn42">
             <p class="MsoFootnoteText"><a href="#_ftnref42" id="_ftn42"><sup>[42]</sup></a>         <span class="titel1"><i><span style="">Hie het der alte parzifal vn(d) der nvwe ein ende vn(d)
                         waz rede hie noch geſchriben | ſtat daz het pfilippes kolin gemaht</span></i></span><span style=""> (L. 827.30<sup>1-0</sup>; Sch. 845.16f.).</span></p>
          </div>
          <div id="ftn43">
             <p class="MsoFootnoteText"><a href="#_ftnref43" id="_ftn43"><sup>[43]</sup></a>         <span class="init"><i><span style="">P</span></i></span><i><span style="">filippez
                      colin der goltſmit</span></i><span style=""> (L. 827.30<sup>527</sup>;
                   ...
                   (1997), S. 88, Anm. 2. Tatsächlich kann die Aussage Kolins <i>Jch bin din tihter
                      ...
                      wider ein goltſmit</i> (L. 827.30<sup>541–544</sup>; Sch. 858.9–12) als Bitte
                   ...
                   (1994), S. 140–143.</span></p>
          </div>
          <div id="ftn44">
             <p class="MsoFootnoteText"><a href="#_ftnref44" id="_ftn44"><sup>[44]</sup></a>         <i><span style="">Als
                      vnz ein cluͦger goltſmit ſeit | Von ſtraſburg philippez colin | Der het diz
                      buͦch dem herren ſin | Von welſch in túczſch gerimet</span></i><span style=""> (L. 827.30<sup>28-31</sup>; Sch. 846.20–23).</span></p>
          </div>
          <div id="ftn45">
             <p class="MsoFootnoteText"><a href="#_ftnref45" id="_ftn45"><sup>[45]</sup></a>         <i><span style="">Nv
                      wil ich úch erſt tuͦn kvnt</span></i><span style=""> (L. 827.30<sup>163</sup>;
                   Sch. 849.23).</span></p>
          </div>
          <div id="ftn46">
             <p class="MsoFootnoteText"><a href="#_ftnref46" id="_ftn46"><sup>[46]</sup></a>         <span style="">Siehe
          ...
          <div id="ftn47">
             <p class="MsoFootnoteText"><a href="#_ftnref47" id="_ftn47"><sup>[47]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Schorbach</span> (1888), S. XXVIII, der die
                   Identität nicht bezweifelt.</span></p>
          </div>
          <div id="ftn48">
             <p class="MsoFootnoteText"><a href="#_ftnref48" id="_ftn48"><sup>[48]</sup></a>         <span style="">SUB
          ...
          <div id="ftn50">
             <p class="MsoFootnoteText"><a href="#_ftnref50" id="_ftn50"><sup>[50]</sup></a>         <i><span lang="DE-CH" style="">Diether Kölbelin</span></i> <span style="">war vermutlich
          ...
          <div id="ftn51">
             <p class="MsoFootnoteText">
                                    <a href="#_ftnref51" id="_ftn51">
                                           <sup>[51]</sup>
                                       </a>
                                    <span lang="EN-US" style="">SUB III, S. 194f., Nr. </span>
                                    <a href="http://gallica.bnf.fr/ark:/12148/bpt6k9401049b/f246.image.r=Urkundenbuch%20der%20Stadt%20Strassburg%20dritter">
                                           <span lang="EN-US" style="">635</span>
                                       </a>
                                    <span lang="EN-US" style=""> (29.4.1309) (<i>Anna begina, nata quondam Burcardi
                      dicti Kolin civis Arg.</i>)<i>.</i></span>
             </p>
          </div>
          <div id="ftn52">
             <p class="MsoFootnoteText">
                                    <a href="#_ftnref52" id="_ftn52">
                                           <sup>[52]</sup>
                                       </a>
                                    <span lang="EN-US" style="">Vgl. <span style="font-variant:small-caps">Schorbach</span>
                   (1888), S. XX, und <span style="font-variant:small-caps">Wittmann-Klemm</span>
                   (1977), S. 5.</span>
             </p>
          </div>
          <div id="ftn53">
             <p class="MsoFootnoteText"><a href="#_ftnref53" id="_ftn53"><sup>[53]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Jäschke</span> (1994), S. 141 (Zit ebd.) mit
                   den Belegstellen aus dem Protokoll des Zeugenverhörs von 1332 nach der Edition
                   im SUB V (S. 1–18) in der Anm. 457.</span></p>
          </div>
          <div id="ftn54">
             <p class="MsoFootnoteText"><a href="#_ftnref54" id="_ftn54"><sup>[54]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Schorbach</span> (1888), S. XX; <span style="font-variant:small-caps">Wittmann-Klemm</span> (1977), S. 6f., und <span style="font-variant:small-caps">Mentgen</span> (1995), S. 81f., Anm. 31. Der
                   ...
                   und gewürdigt hat […].«</span></p>
          </div>
          <div id="ftn55">
             <p class="MsoFootnoteText">
                                    <a href="#_ftnref55" id="_ftn55">
                                           <sup>[55]</sup>
                                       </a>
          ...
          <div id="ftn56">
             <p class="MsoFootnoteText"><a href="#_ftnref56" id="_ftn56"><sup>[56]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Ginsburger</span> (1968a); <span style="font-variant:small-caps">Schwarzfuchs</span> (1995), und <span style="font-variant:small-caps">Mentgen</span> (1995), S. 347–385. Die jüdische
                   Geimeinde in Rappoltsweiler wurde 1338 und 1349 durch Pogrome dezimiert oder
                   ganz ausgelöscht.</span></p>
          </div>
          <div id="ftn57">
             <p class="MsoFootnoteText"><a href="#_ftnref57" id="_ftn57"><sup>[57]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Thompson</span> (1931), S. 15–17. Zur Monser
          ...
          <div id="ftn58">
             <p class="MsoFootnoteText"><a href="#_ftnref58" id="_ftn58"><sup>[58]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Chrétien, Conte du Graal</span>.</span></p>
          </div>
          <div id="ftn59">
             <p class="MsoFootnoteText"><a href="#_ftnref59" id="_ftn59"><sup>[59]</sup></a>         <span style="">Diesen
          ...
          <div id="ftn60">
             <p class="MsoFootnoteText"><a href="#_ftnref60" id="_ftn60"><sup>[60]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Viehhauser-Mery</span> (2009), S. 260–263, und <span style="font-variant:small-caps">Schöller</span> (2009), S. 1–30 (zum
                   Fassungsbegriff) und S. 111–113.</span></p>
          </div>
          <div id="ftn61">
             <p class="MsoFootnoteText"><a href="#_ftnref61" id="_ftn61"><sup>[61]</sup></a>         <span style=" font-variant:small-caps">Schöller</span><span style=""> (2009),
                   S. 111. Siehe dazu auch <span style="font-variant:small-caps">Viehhauser-Mery</span>
                   (2009), S. 134–144.</span></p>
          </div>
          <div id="ftn62">
             <p class="MsoFootnoteText"><a href="#_ftnref62" id="_ftn62"><sup>[62]</sup></a>         <span style="">Zu
          ...
          <div id="ftn65">
             <p class="MsoFootnoteText"><a href="#_ftnref65" id="_ftn65"><sup>[65]</sup></a>         <span style="">Siehe
                   dazu <span style="font-variant:small-caps">Heiser</span> (2002), S. 490f.</span></p>
          </div>
          <div id="ftn66">
             <p class="MsoFootnoteText"><a href="#_ftnref66" id="_ftn66"><sup>[66]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Holznagel</span> (1995); <span style="font-variant:small-caps">Bein</span> (1999), und <span style="font-variant: small-caps">Chen</span> (2015), S. 306–316.</span></p>
          </div>
          <div id="ftn67">
             <p class="MsoFootnoteText"><a href="#_ftnref67" id="_ftn67"><sup>[67]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Brieger</span> (1907), S. 41.</span></p>
          </div>
          <div id="ftn68">
             <p class="MsoFootnoteText"><a href="#_ftnref68" id="_ftn68"><sup>[68]</sup></a>         <span style="">Jedenfalls
                   ...
                   verstorbenen Zisterzienserfrater der Abtei Pairis; vgl. <span style="font-variant: small-caps">Nekrolog Pairis (Ed. Clauss)</span>, S. 66.</span></p>
          </div>
          <div id="ftn69">
             <p class="MsoFootnoteText"><a href="#_ftnref69" id="_ftn69"><sup>[69]</sup></a>         <span style="font-variant:small-caps">Wittmann-Klemm</span>
          ...
          <div id="ftn70">
             <p class="MsoFootnoteText"><a href="#_ftnref70" id="_ftn70"><sup>[70]</sup></a>         <span style="">Für
          ...
          <div id="ftn71">
             <p class="MsoFootnoteText"><a href="#_ftnref71" id="_ftn71"><sup>[71]</sup></a>         <span style="">Zu
          ...
          <div id="ftn72">
             <p class="MsoFootnoteText"><a href="#_ftnref72" id="_ftn72"><sup>[72]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Schorbach</span> (1888), S. X (mit Zuweisung
                   ...
                   (1888), S. X, Anm. 1, dass lediglich ein Schreiber genannt wird.</span></p>
          </div>
          <div id="ftn73">
             <p class="MsoFootnoteText"><a href="#_ftnref73" id="_ftn73"><sup>[73]</sup></a>         Auch <span style="font-variant: small-caps">Obhof</span> (2009), S. 375, spricht im Zusammenhang mit dem <i>von
                   Onheim</i> nicht von einem Schreiber.
             </p>
          </div>
          <div id="ftn74">
             <p class="MsoFootnoteText"><a href="#_ftnref74" id="_ftn74"><sup>[74]</sup></a>         <span style="">Die Darstellung
          ...
          <div id="ftn75">
             <p class="MsoFootnoteText"><a href="#_ftnref75" id="_ftn75"><sup>[75]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Becker</span> (1977), S. 90.</span></p>
          </div>
          <div id="ftn76">
             <p class="MsoFootnoteText"><a href="#_ftnref76" id="_ftn76"><sup>[76]</sup></a>         <span style="">Zu
          ...
          <div id="ftn77">
             <p class="MsoFootnoteText"><a href="#_ftnref77" id="_ftn77"><sup>[77]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Obhof </span>(2009).</span></p>
          </div>
          <div id="ftn78">
             <p class="MsoFootnoteText"><a href="#_ftnref78" id="_ftn78"><sup>[78]</sup></a>         <span style="">Bei <span style="font-variant:small-caps">Obhof </span>(2009), S. 375, »kleine und große
          ...
          <div id="ftn79">
             <p class="MsoFootnoteText"><a href="#_ftnref79" id="_ftn79"><sup>[79]</sup></a>         <span style="">Vgl.
          ...
          <div id="ftn81">
             <p class="MsoFootnoteText"><a href="#_ftnref81" id="_ftn81"><sup>[81]</sup></a>         <span style="">Eine
                   einzeilige, blaue Lombarde auf Bl. </span><router-link to="/V/022r/facsimile">22r</router-link><span style="">b folgt
                   einer ebenfalls blauen, zweizeiligen Lombarde auf Bl. </span><router-link to="/V/022r/facsimile">22r</router-link><span style="">a.</span></p>
          </div>
          <div id="ftn82">
             <p class="MsoFootnoteText"><a href="#_ftnref82" id="_ftn82"><sup>[82]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Obhof</span> (2009), S. 375.</span></p>
          </div>
          <div id="ftn83">
             <p class="MsoFootnoteText"><a href="#_ftnref83" id="_ftn83"><sup>[83]</sup></a>         <span style="">Vgl.
          ...
          <div id="ftn86">
             <p class="MsoFootnoteText"><a href="#_ftnref86" id="_ftn86"><sup>[86]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Heinzer/Stamm Kat. Lichtenthal</span>, S. 44f.
                   und S. 297f.</span></p>
          </div>
          <div id="ftn87">
             <p class="MsoFootnoteText"><a href="#_ftnref87" id="_ftn87"><sup>[87]</sup></a>         <span style="">Vgl.
                   ebd., S. 38, Zit. ebd., und <span style="font-variant:small-caps">Schindele
                      (1995), S. 36.</span></span></p>
          </div>
          <div id="ftn88">
             <p class="MsoFootnoteText"><a href="#_ftnref88" id="_ftn88"><sup>[88]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Rathgeber</span> (1874), S. 3 und 30f., sowie <span style="font-variant:small-caps">Brieger</span> (1907), S. 19.</span></p>
          </div>
          <div id="ftn89">
             <p class="MsoFootnoteText"><a href="#_ftnref89" id="_ftn89"><sup>[89]</sup></a>         <span style="">Vgl.
          ...
          <div id="ftn90">
             <p class="MsoFootnoteText"><a href="#_ftnref90" id="_ftn90"><sup>[90]</sup></a>         <span style="">Vgl. <span class="reference-text"><span style="font-variant:small-caps">Gérard</span>
                      (1872), Bd. 1, </span>S. 184f. und 339–341.</span></p>
          </div>
          <div id="ftn91">
             <p class="MsoFootnoteText"><a href="#_ftnref91" id="_ftn91"><sup>[91]</sup></a>         <span style="">Vgl. </span><a href="http://webserver.erwin-rauner.de/biblcod/bc01_ort_details.php?ortnr=17410&amp;biblnr=1&amp;orts id=PAIRIS"><span style="">Bibliothecae codicum medii aevi</span></a><span style=""> (Angaben teilweise nicht korrekt).</span></p>
          </div>
          <div id="ftn92">
             <p class="MsoFootnoteText"><a href="#_ftnref92" id="_ftn92"><sup>[92]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Beer</span> (1959), S. 26f. et passim, und <span style="font-variant:small-caps">Beer</span> (1965), S. 140.</span></p>
          </div>
          <div id="ftn93">
             <p class="MsoFootnoteText"><a href="#_ftnref93" id="_ftn93"><sup>[93]</sup></a>         <span style="">Dass
                   der Umfang von Hs. V ursprünglich tatsächlich 322 Blätter umfasst hat, zeigt
                   auch die Blattberechnung auf Bl. </span><router-link to="/V/320v/facsimile">320v</router-link><span style="">a, die in
                   Sexternionen den Umfang (nicht den Lagenaufbau) der Handschrift angibt, was
                   möglicherweise der Berechnung des Schreiberlohns diente; vgl. <span style="font-variant:small-caps">Schorbach</span> (1888), S. XV.</span></p>
          </div>
          <div id="ftn94">
             <p class="MsoFootnoteText"><a href="#_ftnref94" id="_ftn94"><sup>[94]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Ute Obhof</span> auf </span><a href="http://www.manuscripta-mediaevalia.de/?xdbdtdn!%22obj%2031576740%22&amp;dmode=doc#|4"><span style="">Manuscripta Mediaevalia</span></a><span style=""> mit der Angabe von Bl. 189r anstelle von Bl. 180r.</span></p>
          </div>
          <div id="ftn95">
             <p class="MsoFootnoteText"><a href="#_ftnref95" id="_ftn95"><sup>[95]</sup></a>         <span style="">Gemeint
          ...
          <div id="ftn96">
             <p class="MsoFootnoteText"><a href="#_ftnref96" id="_ftn96"><sup>[96]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Himmelstein</span> (1861), S. 153 und 155f.; <span style="font-variant:small-caps">Urkunden Augustiner</span>, S. 575f. (Nr. 892),
          ...
          <div id="ftn97">
             <p class="MsoFootnoteText"><a href="#_ftnref97" id="_ftn97"><sup>[97]</sup></a>         <span style="">Vgl. <span style="font-variant:small-caps">Urkundenregesten Bistum Würzburg</span>, S.
                   77f. (Nr. 91) (»der erber man her Hermann, genannt Purrian, Pfarrer (phferrer)
                   von Neustadt«; ebd. S. 78); <span style="font-variant:small-caps">Wagner</span>
                   (1982), S. 169; <span style="font-variant:small-caps">Wagner</span> (1987), S.
                   188f. (Nr. 241: <i>honorabilis vir dominus Hermannus plebanus Noue Ciutatis</i>)
                   und S. 214 (Nr. 304: <i>domini Hermanni plebani in Newstat</i>); <span style="font-variant:small-caps">Bünz</span> (1998), S. 758f. (<i>obiit
                      Heinricus[!] Burian canonicus</i>).</span></p>
          </div>
          <div id="ftn98">
             <p class="MsoFootnoteText"><a href="#_ftnref98" id="_ftn98"><sup>[98]</sup></a>         Möglicherweise zeigt das zweite
          ...
          <div id="ftn99">
             <p class="MsoFootnoteText"><a href="#_ftnref99" id="_ftn99"><sup>[99]</sup></a>         <span style="">Ähnlich
                   ist auch das Wappen des fränkischen Adelsgeschlechts Ehenheim mit Sitz in
                   Enheim (Gemeinde Martinsheim) mit einer rohrförmigen Helmzier; vgl.
                   Scheiblersches Wappenbuch (München,
                       BSB, Cod.icon. 312 c, S. </span><a href="http://daten.digitale-sammlungen.de/~db/bsb00007174/images/index.html?id=00007174&amp;nativeno=85"><span style="">85</span></a><span style="">).</span></p>
          </div>
          <div id="ftn100">
             <p class="MsoFootnoteText"><a href="#_ftnref100" id="_ftn100"><sup>[100]</sup></a>       Zur Entwicklung und Verwendung der
                Helme in Turnieren siehe <span style="font-variant:small-caps">Gamber</span>
                (1985), S. 515f.; <span style="font-variant:small-caps">Gamber</span> (1989); <span style="font-variant:small-caps">Jezler</span> (2014) und <span style="font-variant:small-caps">Jezler</span>/<span style="font-variant:small-caps">Niederhäuser</span>/<span style="font-variant:small-caps">Jezler Kat. Ausstellung Ritterturnier</span>,
                S. 134–147.
             </p>
          </div>
          <div id="ftn101">
             <p class="MsoFootnoteText"><a href="#_ftnref101" id="_ftn101"><sup>[101]</sup></a>       <span style=" font-variant:small-caps">Schorbach</span><span style=""> (1888),
          ...
          <div id="ftn102">
             <p class="MsoFootnoteText"><a href="#_ftnref102" id="_ftn102"><sup>[102]</sup></a>       <span style="">Vgl. <span style="font-variant:small-caps">Fechter</span> (1935), S. 39, und <span style="font-variant:small-caps">Wittmann-Klemm</span> (1977), S. 131.</span></p>
          </div>
          <div id="ftn103">
             <p class="MsoFootnoteText"><a href="#_ftnref103" id="_ftn103"><sup>[103]</sup></a>       Die Besitzeinträge entsprechen den
          ...
          <div id="ftn104">
             <p class="MsoFootnoteText"><a href="#_ftnref104" id="_ftn104"><sup>[104]</sup></a>       <span style="">Siehe
          ...
          <div id="ftn105">
             <p class="MsoFootnoteText"><a href="#_ftnref105" id="_ftn105"><sup>[105]</sup></a>       Auflösung nach dem <span style="font-variant:small-caps">Lexikon Stammbuchsprüche</span>, S. 135.
             </p>
          </div>
          <div id="ftn106">
             <p class="MsoFootnoteText"><a href="#_ftnref106" id="_ftn106"><sup>[106]</sup></a>       <span style="">Vgl.<span style="font-variant:small-caps"> Kerler</span> (1840), S. 137f.; <span style="font-variant:small-caps">Stammtafeln</span> XI, Tafel 82, und <span style="font-variant:small-caps">Stammtafeln</span> XII, Tafel 59. – Zu Elisabeth
                   findet sich auf dem </span><a href="https://digital.blb-karlsruhe.de/blbhs/content/pageview/495093"><span style="">Vorderspiegel</span></a><span style="">
          ...
          <div id="ftn107">
             <p class="MsoFootnoteText"><a href="#_ftnref107" id="_ftn107"><sup>[107]</sup></a>       Auflösung nach <span style="font-variant:small-caps">Lexikon Stammbuchsprüche</span>, S. 114.
             </p>
          </div>
          <div id="ftn108">
             <p class="MsoFootnoteText"><a href="#_ftnref108" id="_ftn108"><sup>[108]</sup></a>
          ...
          <div id="ftn109">
             <p class="MsoFootnoteText"><a href="#_ftnref109" id="_ftn109"><sup>[109]</sup></a>       Auflösung der weit verbreiteten
          ...
          <div id="ftn110">
             <p class="MsoFootnoteText"><a href="#_ftnref110" id="_ftn110"><sup>[110]</sup></a>
          ...
          <div id="ftn111">
             <p class="MsoFootnoteText"><a href="#_ftnref111" id="_ftn111"><sup>[111]</sup></a>      Solche
          ...
          <div id="ftn112">
             <p class="MsoFootnoteText"><a href="#_ftnref112" id="_ftn112"><sup>[112]</sup></a>       <span style=" font-variant:small-caps">Wittmann-Klemm</span><span style="">
                   (1977), S. 132, liest: »Gabwan der schenst Edlest riter/ guot | .ba. kain
                   h..inge von orgelles die Edel frau wol/ gemuot | GOT haltz jn sainer huot«.</span></p>
          </div>
          <div id="ftn113">
             <p class="MsoFootnoteText"><a href="#_ftnref113" id="_ftn113"><sup>[113]</sup></a>       <span style=" font-variant:small-caps">Becker</span><span style=""> (1977), S.
                   91.</span></p>
          </div>
          <div id="ftn114">
             <p class="MsoFootnoteText"><a href="#_ftnref114" id="_ftn114"><sup>[114]</sup></a>       <span style="">Zur
          ...
          <div id="ftn115">
             <p class="MsoFootnoteText"><a href="#_ftnref115" id="_ftn115"><sup>[115]</sup></a>       <span style=" font-variant:small-caps">Wittmann-Klemm</span><span style="">
          ...
          <div id="ftn118">
             <p class="MsoFootnoteText"><a href="#_ftnref118" id="_ftn118"><sup>[118]</sup></a>       <span style="">Vgl. <span style="font-variant:small-caps">Uhland</span> (1840), Zit. S. 259.</span></p>
          </div>
          <div id="ftn119">
             <p class="MsoFootnoteText"><a href="#_ftnref119" id="_ftn119"><sup>[119]</sup></a>       <span style="">Vgl. <span style="font-variant:small-caps">Scheffel Kat. Donaueschingen</span>, S. 15,
                   Zit. S. 1.</span></p>
          </div>
          <div id="ftn120">
             <p class="MsoFootnoteText"><a href="#_ftnref120" id="_ftn120"><sup>[120]</sup></a>       <span style="">Vgl. <span style="font-variant:small-caps">Barack Kat. Donaueschingen</span>, S. VI und S.
                   88, Zit. S. 88.</span></p>
          </div>
          <div id="ftn121">
             <p class="MsoFootnoteText"><a href="#_ftnref121" id="_ftn121"><sup>[121]</sup></a>       <span style="">Vgl. <span style="font-variant:small-caps">Geh</span> (<sup>2</sup>1994); S. 3f., und <span style="font-variant:small-caps">Heinzer</span> (1995).</span></p>
          </div>
          <div id="ftn122">
             <p class="MsoFootnoteText"><a href="#_ftnref122" id="_ftn122"><sup>[122]</sup></a>       <span style="">Dies
                   ...
                   NP 10861) auf Bl. </span><router-link to="/VV/057v/facsimile">57v</router-link><span style="">b (die
                   entsprechende Stelle fehlt in Hs. V infolge Blattverlust).</span></p>
          </div>
          <div id="ftn123">
             <p class="MsoFootnoteText"><a href="#_ftnref123" id="_ftn123"><sup>[123]</sup></a>       <span style="">Vgl.
          ...
          <div id="ftn124">
             <p class="MsoFootnoteText"><a href="#_ftnref124" id="_ftn124"><sup>[124]</sup></a>       <span style="">Vgl.
                   dazu bspw. Hs. V', Bl. </span><router-link to="/VV/170v/facsimile">170v</router-link><span style="">, 2. Zeile
                   ...
                   geschriebe Wort streicht und mit einer eigenen Formulieren fortfährt.</span></p>
          </div>
          <div id="ftn125">
             <p class="MsoFootnoteText"><a href="#_ftnref125" id="_ftn125"><sup>[125]</sup></a>       <span style=" font-variant:small-caps">Schneider</span><span style=""> (2009),
                   S. 141.</span></p>
          </div>
          <div id="ftn126">
             <p class="MsoFootnoteText"><a href="#_ftnref126" id="_ftn126"><sup>[126]</sup></a>       In der
                   Forschung gilt die Meinung, dass der erste Teil des ›Rappoltsteiner Parzifal‹
                   ebenfalls kopiert wurde, heute jedoch verloren ist; vgl. z. B. <span style="font-variant:small-caps">von der Hagen</span> (1818), S. 304 [14. Brief
                   vom 15./16. November 1816]; <span style="font-variant:small-caps">Schorbach</span>
                   (1888), S. XVII; <span style="font-variant:small-caps">Hartl</span> (1928), S.
                   18; <span style="font-variant:small-caps">Wittmann-Klemm</span> (1977), S. 1; <span style="font-variant:small-caps">Schirok</span> (1982), S. 38 (Nr. 27); <span style="font-variant:small-caps">Mertens</span> (1998), S. 300; <span style="font-variant:small-caps">Schöller</span> (2009), S. 103, Anm. 191, und <span style="font-variant:small-caps">Chen</span> (2015), S. 11. Die von <span style="font-variant:small-caps">Michael Stolz</span> in die Diskussion
          ...
          <div id="ftn127">
             <p class="MsoFootnoteText"><a href="#_ftnref127" id="_ftn127"><sup>[127]</sup></a>       <span style=" font-variant:small-caps">Miller</span><span style="">/<span style="font-variant:small-caps">Zimmermann Kat. Heidelberg</span>, S. 70
                   (Miller). Der Hersausgeber<span style="font-variant:small-caps"> Karl Schorbach</span>
                   hat 1888 mit besonderem Hinweis auf den Epilog konstatiert, dass in V'
                   "[d]er elsässische Dialekt der Vorlage […] bis auf geringe Spuren
                   verwischt" worden sei; <span style="font-variant:small-caps">Schorbach</span>
                   (1888), S. XVIII.</span></p>
          </div>
          <div id="ftn128">
             <p class="MsoFootnoteText"><a href="#_ftnref128" id="_ftn128"><sup>[128]</sup></a>       <span style="">Ich
                   ...
                   (2017) zugrunde liegen, zur Verfügung gestellt hat. Da dort die Überschrift
                   mitgezählt wurden, bringen die Angaben eine leicht gerundete Zahlen.</span></p>
          </div>
          <div id="ftn129">
             <p class="MsoFootnoteText"><a href="#_ftnref129" id="_ftn129"><sup>[129]</sup></a>       <span style="">Die
          ...
          <div id="ftn130">
             <p class="MsoFootnoteText"><a href="#_ftnref130" id="_ftn130"><sup>[130]</sup></a>       <span style=" font-variant:small-caps">Matthias Miller</span><span style="">
          ...
          <div id="ftn131">
             <p class="MsoFootnoteText"><a href="#_ftnref131" id="_ftn131"><sup>[131]</sup></a>       <span style="">Siehe
                   dazu <span style="font-variant:small-caps">Fasching</span> (2018).</span></p>
          </div>
          <div id="ftn132">
             <p class="MsoFootnoteText"><a href="#_ftnref132" id="_ftn132"><sup>[132]</sup></a>       <span style=" font-variant:small-caps">Schneider</span><span style=""> (2009),
          ...
          <div id="ftn133">
             <p class="MsoFootnoteText"><a href="#_ftnref133" id="_ftn133"><sup>[133]</sup></a>       <span style="">Siehe
                   dazu <span style="font-variant:small-caps">Fasching</span> (2018), S. ### (mit
                   Schriftproben).</span></p>
          </div>
          <div id="ftn134">
             <p class="MsoFootnoteText"><a href="#_ftnref134" id="_ftn134"><sup>[134]</sup></a>       <span style="">Zur
          ...
          <div id="ftn135">
             <p class="MsoFootnoteText"><a href="#_ftnref135" id="_ftn135"><sup>[135]</sup></a>       <span style="">Zum
                   Inhalt der Codices siehe <span style="font-variant:small-caps">Fasching</span>
                   (2018), S. ###–###.</span></p>
          </div>
          <div id="ftn136">
             <p class="MsoFootnoteText"><a href="#_ftnref136" id="_ftn136"><sup>[136]</sup></a>       <span style="">Ein
                   klösterliches Skriptorium als Herstellungsort für möglich halten <span style="font-variant:small-caps">Schnelbögl</span> (1930), S. 5; <span style="font-variant:small-caps">Becker</span> (1977), S. 91, Anm. 1, 122, Anm.
                   2, und 181, Anm. 3; <span style="font-variant:small-caps">Backes</span> (1992),
                   S. 54, Anm. 24, und <span style="font-variant:small-caps">Miller</span>/<span style="font-variant:small-caps">Zimmermann Kat. Heidelberg</span>, S. 241, 281
                   und 319. Die Begründung <span style="font-variant:small-caps">Schnelbögl</span>s,
                   zwei Texte würden mit einem Bittgebet mit <i>Amen </i>(Codd. Pal. germ. 364,
                   Bl. </span><a href="http://digi.ub.uni-heidelberg.de/diglit/cpg364/0309/image"><span style="">151r</span></a><span style="">b [Schluß
                   des Lohengrin], und 383, Bl. </span><a href="http://digi.ub.uni-heidelberg.de/diglit/cpg383/0372/image"><span style="">183v</span></a><span style="">a [Schluß
                   des Jüngeren Titurel]) schließen und am Blattrand von Cod. Pal. germ. 404, Bl. </span><a href="http://digi.ub.uni-heidelberg.de/diglit/cpg404/0087/image"><span style="">40r</span></a><span style="">a, stehe</span><span style="">
                                       <i>dominus</i>, ist nicht stichhaltig. Diese Zusätze,
                   die aus den Vorlagen stammen können, finden sich auch in textgeschichtlich
                   unabhängigen Parallelhandschriften; siehe dazu <span style="font-variant:small-caps">Fasching</span>
                   (2018), S. ###.</span></p>
          </div>
          <div id="ftn137">
             <p class="MsoFootnoteText"><a href="#_ftnref137" id="_ftn137"><sup>[137]</sup></a>       Vgl. <span lang="DE-CH" style="font-variant:small-caps">Wirth</span>
          ...
          <div id="ftn138">
             <p class="MsoFootnoteText"><a href="#_ftnref138" id="_ftn138"><sup>[138]</sup></a>       <span style="">Vgl. <span style="font-variant:small-caps">Heller</span> (1845), S. 251–253, und <span style="font-variant:small-caps">Mone</span> (1862), S. 142–147 (beide mit
                   Abdruck der Urkunde von 1408, in der der Kauf gemeldet wurde); <span style="font-variant:small-caps">Schottenloher</span> (1907), S. 419, und <span style="font-variant:small-caps">Backes</span> (1992), S. 103f.</span>
                   <span lang="DE-CH" style="font-variant:small-caps">Wirth</span><span lang="DE-CH"> (1982), S. 25, weist darauf
                   hin, dass die Bücher nicht unbedingt in seinem Besitz waren, sondern
                   möglicherweise zu den Beständen zählten, »über die er von Amts wegen
                   disponieren konnte.«</span></p>
          </div>
          <div id="ftn139">
             <p class="MsoFootnoteText"><a href="#_ftnref139" id="_ftn139"><sup>[139]</sup></a> Vgl.
          ...
          <div id="ftn140">
             <p class="MsoFootnoteText"><a href="#_ftnref140" id="_ftn140"><sup>[140]</sup></a>       <span style="">Vgl. <span style="font-variant:small-caps">Jakob</span> (1998), S. 125, Zit. ebd.</span></p>
          </div>
          <div id="ftn141">
             <p class="MsoFootnoteText"><a href="#_ftnref141" id="_ftn141"><sup>[141]</sup></a>       <span style=" font-variant:small-caps">Heller</span> (1845), S.
                   251. Kritisch gegenüber dieser Aussage äußert sich <span lang="DE-CH" style="font-variant:small-caps">Wirth</span> (1982), S. 26.</p>
          </div>
          <div id="ftn142">
             <p class="MsoFootnoteText"><a href="#_ftnref142" id="_ftn142"><sup>[142]</sup></a>       <span style="">Vgl. <span style="font-variant:small-caps">Heller</span> (1845); <span style="font-variant: small-caps">von Wegele</span> (1883); <span style="font-variant:small-caps">Wendehorst</span>
                   (1982); <span style="font-variant:small-caps">Schlechter</span>/<span style="font-variant:small-caps">Stamm</span> (2000), S. 52. Siehe dazu auch den
                   Eintrag im Nekrolog der Bamberger Klarissen: </span><a href="https://digital.blb-karlsruhe.de/blbhs/content/pageview/148745"><span style="">Karlsruhe, BLB, St. Peter perg. 57, 14v</span></a><span style="">.</span></p>
          </div>
          <div id="ftn143">
             <p class="MsoFootnoteText"><a href="#_ftnref143" id="_ftn143"><sup>[143]</sup></a>       <span style="">Bamberg,
                   SB, Msc.Can.51. Zur Hs. siehe </span><span lang="DE-CH" style=" font-variant:small-caps">Leitschuh Kat. Bamberg</span><span lang="DE-CH" style="">, S. 924f. (Nr. 51) u. 930f.; </span><span style="font-variant:small-caps">Pfändtner/Westphal Kat. Bamberg</span><span style="">, S. 311–313 (Kat.-Nr. 207) und Abb. 647–649. Diesen
                   Codex lieh Lamprecht von Brun an den im Dienste eines Herren von Ochsenstein
                   (der Straßburger Domdekan Johann Freiherr von Ochsenstein, 1331–1386?)
                   stehenden Magister Heinrich von Heydeck aus; vgl. </span><span lang="DE-CH" style="font-variant:small-caps">Schottenloher</span><span lang="DE-CH" style=""> (1907), S. 420.</span></p>
          </div>
          <div id="ftn144">
             <p class="MsoFootnoteText"><a href="#_ftnref144" id="_ftn144"><sup>[144]</sup></a>       <span style="">Bamberg,
                   SB, Msc.Can.58. Zur Hs. siehe </span><span lang="DE-CH" style=" font-variant:small-caps">Schottenloher</span><span lang="DE-CH" style=""> (1907), S. 420; <span style="font-variant:small-caps">Leitschuh Kat.
          ...
          <div id="ftn145">
             <p class="MsoFootnoteText"><a href="#_ftnref145" id="_ftn145"><sup>[145]</sup></a>       <span style="">V</span><span style="">gl. </span><span style="font-variant: small-caps">Friedrich von Hohenlohe, Rechtsbuch (Ed. Höfler)</span><span style="">; <span style="font-variant:small-caps">Schottenloher</span>
                   (1907), S. 420</span><span style="">.</span></p>
          </div>
          <div id="ftn146">
              <p class="MsoFootnoteText"><a href="#_ftnref146" id="_ftn146"><sup>[146]</sup></a>
                  <a href="http://digi.ub.uni-heidelberg.de/diglit/bav_pal_lat_871?ui_lang=ger"><span lang="it">Città del Vaticano, BAV, Pal. lat.
                  87</span></a>1 (Teil II mit Nachtrag). Zur Hs. und deren Geschichte siehe <span lang="de" style="font-variant:small-caps">Wirth</span>
                  <span lang="DE-CH"> (1982), S. 19–22 und, sowie <span style="font-variant:small-caps">Wetzel</span> (1995), S. 23f.</span>
              </p>
          </div>
          <div id="ftn147">
             <p class="MsoFootnoteText"><a href="#_ftnref147" id="_ftn147"><sup>[147]</sup></a> <a
          ...
          <div id="ftn148">
             <p class="MsoFootnoteText">
                                    <a href="#_ftnref148" id="_ftn148">
                                           <sup>[148]</sup>
                                       </a>
                                    Vgl. <span style="font-variant:small-caps">Miller</span> (2007).
             </p>
          </div>
          <div id="ftn149">
             <p class="MsoFootnoteText">
                                    <a href="#_ftnref149" id="_ftn149">
                                           <sup>[149]</sup>
                                       </a>
                                    <span style=""> Città del Vaticano, BAV, </span>
                                    <a href="http://digi.ub.uni-heidelberg.de/diglit/bav_pal_lat_1956/0075/image?sid=4c41143a06d8e9180a77a6f45ac0dca7">
                                           <span style="">Pal. lat. 1956 (Katalog der Palatina, 1581,
                      Geschichte), S. 56</span>
                                       </a>
                                    <span style="">, bzw. Pal. lat.
                   1931, Bl. 306r; zit. nach <span style="font-variant:small-caps">Miller</span>
                   (2007), S. 308.</span>
             </p>
          </div>
          <div id="ftn150">
             <p class="MsoFootnoteText">
                                    <a href="#_ftnref150" id="_ftn150">
                                           <sup>[150]</sup>
                                       </a>
                                    <span style=""> Heidelberg, UB, Cod. Pal. germ. 364, Inhaltsangabe von
                   anderer Hand auf Bl. </span>
                                    <a href="http://digi.ub.uni-heidelberg.de/diglit/cpg364/0009/image?sid=90930507383b80b08aa227cc67f0c30c">
                                           <span style="">1r</span>
                                       </a>
                                    <span style="">: <i>Parcefall
                      vnd Lorangrin</i>. Die Bezeichnung <i>gleiches bunds</i> weist auf den unter
                   [Nr. 1] aufgelistete Prosa-Lancelot-Handschrift, bei der es sich wahrscheinlich
                   um den Heidelberger </span>
                                    <a href="http://digi.ub.uni-heidelberg.de/diglit/cpg147?sid=90930507383b80b08aa227cc67f0c30c">
                                           <span style="">Cod. Pal. germ. 147</span>
                                       </a>
                                    <span style=""> handelt. Die Beschreibung des Einbands <i>Perment, brett, ſchwartʒ |
                      leder bucklen</i> trifft auch auf den erhaltenen Ottheinrich-Einband des </span>
                                    <a href="http://digi.ub.uni-heidelberg.de/diglit/cpg394/0001/image?sid=90930507383b80b08aa227cc67f0c30c">
                                           <span style="">Cod. Pal. germ. 394</span>
                                       </a>
                                    <span style=""> (Bruder Philipp, Marienleben) zu, der im Katalog der Schloßbibliothek
                   von 1581 auf S. </span>
                                    <a href="http://digi.ub.uni-heidelberg.de/diglit/bav_pal_lat_1956/0083?sid=4965b4e6ec107f8cdf0cf1062a90a0a3">
                                           <span style="">64</span>
                                       </a>
                                    <span style=""> wie der
                   Cod. Pal. germ. 147 beschrieben wird: <i>brett(er), ſchw. leder, b#.ucklen</i>.</span>
             </p>
          </div>
          <div id="ftn151">
             <p class="MsoFootnoteText">
                                    <a href="#_ftnref151" id="_ftn151">
                                           <sup>[151]</sup>
                                       </a>
          ...
          <div id="ftn154">
             <p class="MsoFootnoteText"><a href="#_ftnref154" id="_ftn154"><sup>[154]</sup></a> Vgl.
          ...
          <div id="ftn156">
             <p class="MsoFootnoteText">
                                    <a href="#_ftnref156" id="_ftn156">
                                           <sup>[156]</sup>
                                       </a>
                                    <span style=""> Dasselbe Papier findet sich auch in den Codd. </span>
                                    <a href="http://digi.ub.uni-heidelberg.de/diglit/cpg167">
                                           <span style="">Pal. germ. 167</span>
                                       </a>
                                    <span style=""> (Sachsenspiegel
                   und Schwabenspiegel) (Capsanummer: <i>C. 173</i>, alte römische Signatur: 1651)
                   (<span style="font-variant:small-caps">Zimmermann Kat. Heidelberg</span>, S.
                   386) und </span>
                                    <a href="http://digi.ub.uni-heidelberg.de/diglit/cpg333">
                                           <span style="">333</span>
                                       </a>
                                    <span style=""> (Ulrich
                   von Etzenbach: Alexander, Alexander-Anhang) (<i>C. 92</i>); Vgl. <span style="font-variant:small-caps">Miller</span>/<span style="font-variant:small-caps">Zimmermann
                      Kat. Heidelberg</span>, S. 111 (Beschreibung Miller). In diesen beiden Hss.
                   zusammen mit gerautetem Wappenschild, das sich auch in folgenden Hss. findet:
                   Codd. Pal. germ. </span>
                                    <a href="http://digi.ub.uni-heidelberg.de/diglit/cpg28">
                                           <span style="">28</span>
                                       </a>
                                    <span style=""> (<i>C. 179</i>),
                   </span>
                                    <a href="http://digi.ub.uni-heidelberg.de/diglit/cpg60">
                                           <span style="">60</span>
                                       </a>
                                    <span style=""> (<i>C. 120</i>),
                   </span>
                                    <a href="http://digi.ub.uni-heidelberg.de/diglit/cpg68">
                                           <span style="">68</span>
                                       </a>
                                    <span style=""> (<i>C. 128</i>),
                   </span>
                                    <a href="http://digi.ub.uni-heidelberg.de/diglit/cpg115">
                                           <span style="">115</span>
                                       </a>
                                    <span style=""> (<i>C. 84</i>),
                   </span>
                                    <a href="http://digi.ub.uni-heidelberg.de/diglit/cpg139">
                                           <span style="">139</span>
                                       </a>
                                    <span style=""> (<i>C. 92</i>),
                   </span>
                                    <a href="http://digi.ub.uni-heidelberg.de/diglit/cpg163">
                                           <span style="">163</span>
                                       </a>
                                    <span style=""> (<i>C. 107</i>),
                   </span>
                                    <a href="http://digi.ub.uni-heidelberg.de/diglit/cpg167">
                                           <span style="">167</span>
                                       </a>
                                    <span style=""> (<i>C. 173</i>)
                   und </span>
                                    <a href="http://digi.ub.uni-heidelberg.de/diglit/cpg214">
                                           <span style="">214</span>
                                       </a>
                                    <span style="">; vgl. <span style="font-variant:small-caps">Zimmermann</span> (2003), S. XVII.</span>
             </p>
          </div>
          <div id="ftn157">
             <p class="MsoFootnoteText">
          ...
          <div id="ftn159">
             <p class="MsoFootnoteText">
                                    <a href="#_ftnref159" id="_ftn159">
                                           <sup>[159]</sup>
                                       </a>
                                    <span style=""> vgl. <span style="font-variant:small-caps">von der
                      Hagen</span> (1818), S. 304 (14. Brief vom 15./16. November 1816)
                   (Hervorhebungen im Original).</span>
             </p>
          </div>
       </div>
    </div>
